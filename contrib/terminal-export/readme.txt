...
Пусть на ПК с Windows кладбища Военного есть папка d:\terminal, в которой файлы:
...
Время запуска задания -- в какое-то рабочее время ежедневно. Тогда в это время
будет появляться (обновляться) файл export.csv для Военного кладбища
...
Возможно, еще потребуется прописать путь к программе psftp.exe в системную
