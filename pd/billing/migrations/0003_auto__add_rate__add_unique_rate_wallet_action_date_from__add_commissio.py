...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('billing_commission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('payment', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['billing.Payment'], unique=True)),
            ('share', self.gf('django.db.models.fields.FloatField')()),
            ('source_ct', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('source_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ))
        db.send_create_signal('billing', ['Commission'])

        # Adding model 'Io'
        db.create_table('billing_io', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('payment', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['billing.Payment'], unique=True)),
        ...
        db.send_create_signal('billing', ['Io'])

        # Adding model 'Wallet'
        db.create_table('billing_wallet', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('org', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Org'])),
            ('currency', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['billing.Currency'])),
            ('amount', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=20, decimal_places=2)),
        ))
        db.send_create_signal('billing', ['Wallet'])

        # Adding unique constraint on 'Wallet', fields ['org', 'currency']
        db.create_unique('billing_wallet', ['org_id', 'currency_id'])

        # Adding model 'Ad'
        db.create_table('billing_ad', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('payment', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['billing.Payment'], unique=True)),
            ('ugh', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Org'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Product'])),
            ('action', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('rate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['billing.Rate'], null=True)),
        ))
        db.send_create_signal('billing', ['Ad'])

        # Adding model 'Payment'
        db.create_table('billing_payment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('wallet_from', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payment_from', null=True, to=orm['billing.Wallet'])),
            ('wallet_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payment_to', null=True, to=orm['billing.Wallet'])),
        ...
        # Adding field 'Currency.short_name'
        db.add_column('billing_currency', 'short_name',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('billing_commission')

        # Deleting model 'Io'
        db.delete_table('billing_io')

        # Deleting model 'Wallet'
        db.delete_table('billing_wallet')

        # Deleting model 'Ad'
        db.delete_table('billing_ad')

        # Deleting model 'Payment'
        db.delete_table('billing_payment')

        # Deleting field 'Currency.short_name'
        db.delete_column('billing_currency', 'short_name')
