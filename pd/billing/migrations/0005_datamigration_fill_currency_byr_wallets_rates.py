...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        if not created:
            print "!!! Attention! BYR currency already exists"
        
        print "*** Filling RUR wallets for existing loru and ughs, and rates for ughs"
        call_command('fill_wallets_rates', args=('RUR', ))
