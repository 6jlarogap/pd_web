    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(max_length=255, verbose_name='\u0414\u0435\u0439\u0441\u0442\u0432\u0438\u0435', choices=[(b'publish', '\u041f\u043e\u043a\u0430\u0437'), (b'update', '\u041e\u0431\u043d\u043e\u0432\u043b\u0435\u043d\u0438\u0435'), (b'disable', '\u0421\u043d\u044f\u0442\u0438\u0435 \u0441 \u043f\u043e\u043a\u0430\u0437\u0430')])),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.FileField(upload_to=b'icons', null=True, verbose_name='\u0418\u043a\u043e\u043d\u043a\u0430', blank=True)),
            ],
            options={
                'verbose_name': '\u0412\u0430\u043b\u044e\u0442\u0430',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.TextField(default=b'', verbose_name='\u041f\u0440\u0438\u043c\u0435\u0447\u0430\u043d\u0438\u0435')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('action', models.CharField(max_length=255, verbose_name='\u0414\u0435\u0439\u0441\u0442\u0432\u0438\u0435', choices=[(b'publish', '\u041f\u043e\u043a\u0430\u0437'), (b'update', '\u041e\u0431\u043d\u043e\u0432\u043b\u0435\u043d\u0438\u0435')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('amount', models.DecimalField(default=b'0.00', verbose_name='\u041e\u0441\u0442\u0430\u0442\u043e\u043a', max_digits=20, decimal_places=2)),
