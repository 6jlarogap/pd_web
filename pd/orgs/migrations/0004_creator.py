...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('orgs_organization', 'owner_id')

        # Adding field 'Organization.creator'
        db.add_column('orgs_organization', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Adding field 'Organization.date_of_creation'
        db.add_column('orgs_organization', 'date_of_creation',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Organization.type'
        db.alter_column('orgs_organization', 'type', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):
        # Adding field 'Organization.owner'
        db.add_column('orgs_organization', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Deleting field 'Organization.creator'
        db.delete_column('orgs_organization', 'creator_id')

        # Deleting field 'Organization.date_of_creation'
        db.delete_column('orgs_organization', 'date_of_creation')


        # Changing field 'Organization.type'
        db.alter_column('orgs_organization', 'type', self.gf('django.db.models.fields.CharField')(default='', max_length=15))
    ...
    models = {
        ...
        'orgs.bankaccount': {
            ...
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['orgs.Organization']"}),
