...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Log.msg'
        db.alter_column('logs_log', 'msg', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Log.msg'
        db.alter_column('logs_log', 'msg', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'logs.log': {
            ...
            'obj_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
