...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeleteLog'
        db.create_table('logs_deletelog', (
            ...
            ('dt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('parent_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, db_index=True)),
        ))
        db.send_create_signal('logs', ['DeleteLog'])


    def backwards(self, orm):
        # Deleting model 'DeleteLog'
        db.delete_table('logs_deletelog')
    ...
    models = {
        ...
        'logs.deletelog': {
            ...
            'parent_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'db_index': 'True'})
        },
        'logs.log': {
