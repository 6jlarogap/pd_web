...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ThankUser'
        db.create_table('users_thankuser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('login_phone', self.gf('django.db.models.fields.DecimalField')(unique=True, max_digits=15, decimal_places=0)),
            ('password', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('users', ['ThankUser'])

        # Adding model 'Thank'
        db.create_table('users_thank', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('customperson', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.CustomPerson'])),
        ))
        db.send_create_signal('users', ['Thank'])

        # Adding unique constraint on 'Thank', fields ['user', 'customperson']
        db.create_unique('users_thank', ['user_id', 'customperson_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Thank', fields ['user', 'customperson']
        db.delete_unique('users_thank', ['user_id', 'customperson_id'])

        # Deleting model 'ThankUser'
        db.delete_table('users_thankuser')

        # Deleting model 'Thank'
        db.delete_table('users_thank')
