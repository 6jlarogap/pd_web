...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserPhoto.comment'
        db.alter_column('users_userphoto', 'comment', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'OrgContract.comment'
        db.alter_column('users_orgcontract', 'comment', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'OrgCertificate.comment'
        db.alter_column('users_orgcertificate', 'comment', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'RegisterProfileContract.comment'
        db.alter_column('users_registerprofilecontract', 'comment', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'RegisterProfileScan.comment'
        db.alter_column('users_registerprofilescan', 'comment', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'UserPhoto.comment'
        db.alter_column('users_userphoto', 'comment', self.gf('django.db.models.fields.CharField')(max_length=96))

        # Changing field 'OrgContract.comment'
        db.alter_column('users_orgcontract', 'comment', self.gf('django.db.models.fields.CharField')(max_length=96))

        # Changing field 'OrgCertificate.comment'
        db.alter_column('users_orgcertificate', 'comment', self.gf('django.db.models.fields.CharField')(max_length=96))

        # Changing field 'RegisterProfileContract.comment'
        db.alter_column('users_registerprofilecontract', 'comment', self.gf('django.db.models.fields.CharField')(max_length=96))

        # Changing field 'RegisterProfileScan.comment'
        db.alter_column('users_registerprofilescan', 'comment', self.gf('django.db.models.fields.CharField')(max_length=96))
