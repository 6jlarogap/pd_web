...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'YoutubeVote'
        db.create_table('users_youtubevote', (
            ...
            ('yid', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
        ...
        db.send_create_signal('users', ['YoutubeVote'])


    def backwards(self, orm):
        # Deleting model 'YoutubeVote'
        db.delete_table('users_youtubevote')
