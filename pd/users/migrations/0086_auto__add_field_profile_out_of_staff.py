...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.out_of_staff'
        db.add_column('users_profile', 'out_of_staff',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.out_of_staff'
        db.delete_column('users_profile', 'out_of_staff')
