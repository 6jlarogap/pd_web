...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Org.archive_burial_fact_date_required'
        db.delete_column('users_org', 'archive_burial_fact_date_required')


    def backwards(self, orm):
        # Adding field 'Org.archive_burial_fact_date_required'
        db.add_column('users_org', 'archive_burial_fact_date_required',
