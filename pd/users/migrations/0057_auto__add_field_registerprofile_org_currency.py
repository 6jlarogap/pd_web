...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegisterProfile.org_currency'
        db.add_column('users_registerprofile', 'org_currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['billing.Currency']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegisterProfile.org_currency'
        db.delete_column('users_registerprofile', 'org_currency_id')
    ...
    models = {
        ...
        'users.registerprofile': {
            ...
            'org_currency': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['billing.Currency']"}),
