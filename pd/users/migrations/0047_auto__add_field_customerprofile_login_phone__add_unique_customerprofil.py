...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerProfile.login_phone'
        db.add_column('users_customerprofile', 'login_phone',
                      self.gf('django.db.models.fields.DecimalField')(db_index=True, null=True, max_digits=15, decimal_places=0, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'CustomerProfile', fields ['login_phone']
        db.create_unique('users_customerprofile', ['login_phone'])


    def backwards(self, orm):
        # Removing unique constraint on 'CustomerProfile', fields ['login_phone']
        db.delete_unique('users_customerprofile', ['login_phone'])

        # Deleting field 'CustomerProfile.login_phone'
        db.delete_column('users_customerprofile', 'login_phone')
