    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.FileField(upload_to='dover', null=True, verbose_name='\u0421\u043a\u0430\u043d \u0434\u043e\u0432\u0435\u0440\u0435\u043d\u043d\u043e\u0441\u0442\u0438', blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dt_created', models.DateTimeField(auto_now_add=True, verbose_name='\u0414\u0430\u0442\u0430/\u0432\u0440\u0435\u043c\u044f \u0441\u043e\u0437\u0434\u0430\u043d\u0438\u044f')),
                ('dt_modified', models.DateTimeField(auto_now=True, verbose_name='\u0414\u0430\u0442\u0430/\u0432\u0440\u0435\u043c\u044f \u043c\u043e\u0434\u0438\u0444\u0438\u043a\u0430\u0446\u0438\u0438')),
                ('provider', models.CharField(max_length=100, verbose_name='\u041f\u0440\u043e\u0432\u0430\u0439\u0434\u0435\u0440', choices=[('yandex', '\u042f\u043d\u0434\u0435\u043a\u0441'), ('facebook', 'Facebook'), ('google', 'Google'), ('vk', '\u0412\u041a\u043e\u043d\u0442\u0430\u043a\u0442\u0435'), ('odnoklassniki', '\u041e\u0434\u043d\u043e\u043a\u043b\u0430\u0441\u0441\u043d\u0438\u043a\u0438')])),
                ...
                ('middle_name', models.CharField(default='', max_length=255, verbose_name='\u041e\u0442\u0447\u0435\u0441\u0442\u0432\u043e \u0443 \u043f\u0440\u043e\u0432\u0430\u0439\u0434\u0435\u0440\u0430')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dt_created', models.DateTimeField(auto_now_add=True, verbose_name='\u0414\u0430\u0442\u0430/\u0432\u0440\u0435\u043c\u044f \u0441\u043e\u0437\u0434\u0430\u043d\u0438\u044f')),
                ('dt_modified', models.DateTimeField(auto_now=True, verbose_name='\u0414\u0430\u0442\u0430/\u0432\u0440\u0435\u043c\u044f \u043c\u043e\u0434\u0438\u0444\u0438\u043a\u0430\u0446\u0438\u0438')),
                ('type', models.CharField(max_length=255, verbose_name='\u0422\u0438\u043f', choices=[('company', '\u042e\u0440\u043b\u0438\u0446\u043e'), ('zags', '\u0417\u0410\u0413\u0421'), ('medic', '\u041c\u0435\u0434. \u0443\u0447\u0440\u0435\u0436\u0434\u0435\u043d\u0438\u0435'), ('loru', '\u041b\u041e\u0420\u0423'), ('ugh', '\u041e\u041c\u0421')])),
                ...
                ('full_name', models.CharField(default='', max_length=255, verbose_name='\u041f\u043e\u043b\u043d\u043e\u0435 \u043d\u0430\u0437\u0432\u0430\u043d\u0438\u0435', blank=True)),
                ('description', models.TextField(null=True, verbose_name='\u041e\u043f\u0438\u0441\u0430\u043d\u0438\u0435, \u043d\u0430\u043f\u0440\u0430\u0432\u043b\u0435\u043d\u0438\u0435 \u0434\u0435\u044f\u0442\u0435\u043b\u044c\u043d\u043e\u0441\u0442\u0438', blank=True)),
                ('inn', models.CharField(default='', max_length=255, verbose_name='\u0418\u041d\u041d', blank=True)),
                ('kpp', models.CharField(default='', max_length=255, verbose_name='\u041a\u041f\u041f', blank=True)),
                ('ogrn', models.CharField(default='', max_length=255, verbose_name='\u041e\u0413\u0420\u041d/\u041e\u0413\u0420\u042e\u041b', blank=True)),
                ('director', models.CharField(default='', max_length=255, verbose_name='\u0414\u0438\u0440\u0435\u043a\u0442\u043e\u0440', blank=True)),
                ('basis', models.CharField(default='charter', max_length=255, verbose_name='\u041e\u0441\u043d\u043e\u0432\u0430\u043d\u0438\u0435 \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u044f \u0434\u0438\u0440\u0435\u043a\u0442\u043e\u0440\u0430', choices=[('charter', '\u0443\u0441\u0442\u0430\u0432\u0430'), ('condition', '\u043f\u043e\u043b\u043e\u0436\u0435\u043d\u0438\u044f'), ('certificate', '\u0441\u0432\u0438\u0434\u0435\u0442\u0435\u043b\u044c\u0441\u0442\u0432\u0430'), ('proxy', '\u0434\u043e\u0432\u0435\u0440\u0435\u043d\u043d\u043e\u0441\u0442\u0438')])),
                ...
                ('fax', models.CharField(default='', max_length=20, verbose_name='\u0424\u0430\u043a\u0441', blank=True)),
                ...
                ('worktime', models.CharField(default='', max_length=255, verbose_name='\u0412\u0440\u0435\u043c\u044f \u0440\u0430\u0431\u043e\u0442\u044b (\u0427\u0427:\u041c\u041c - \u0427\u0427:\u041c\u041c)', blank=True)),
                ('site', models.URLField(default='', verbose_name='\u0421\u0430\u0439\u0442', blank=True)),
                ('shop_site', models.URLField(default='', verbose_name='\u0421\u0430\u0439\u0442 \u043c\u0430\u0433\u0430\u0437\u0438\u043d\u0430', blank=True)),
                ...
                ('opf_order', models.CharField(default='org', max_length=255, verbose_name='\u0417\u0430\u043a\u0430\u0437\u0447\u0438\u043a \u043f\u043e \u0443\u043c\u043e\u043b\u0447\u0430\u043d\u0438\u044e \u0432 \u0437\u0430\u043a\u0430\u0437\u0435', choices=[('org', '\u042e\u041b'), ('person', '\u0424\u041b')])),
                ('numbers_algo', models.CharField(default='manual', max_length=255, verbose_name='\u0417\u0430\u043f\u043e\u043b\u043d\u0435\u043d\u0438\u0435 \u043d\u043e\u043c\u0435\u0440\u0430 \u0437\u0430\u0445\u043e\u0440\u043e\u043d\u0435\u043d\u0438\u044f', choices=[('empty', '\u041e\u0441\u0442\u0430\u0432\u0438\u0442\u044c \u043f\u0443\u0441\u0442\u044b\u043c'), ('manual', '\u0412\u0440\u0443\u0447\u043d\u0443\u044e'), ('year_ugh', '\u0413\u043e\u0434 + \u043f\u043e\u0440\u044f\u0434\u043a\u043e\u0432\u044b\u0439 (\u0432 \u043f\u0440\u0435\u0434\u0435\u043b\u0430\u0445 \u043e\u0440\u0433\u0430\u043d\u0438\u0437\u0430\u0446\u0438\u0438)'), ('year_cemetery', '\u0413\u043e\u0434 + \u043f\u043e\u0440\u044f\u0434\u043a\u043e\u0432\u044b\u0439 (\u0432 \u043f\u0440\u0435\u0434\u0435\u043b\u0430\u0445 \u043a\u043b\u0430\u0434\u0431\u0438\u0449\u0430)'), ('year_month_ugh', '\u0413\u043e\u0434 + \u043c\u0435\u0441\u044f\u0446 + \u043f\u043e\u0440\u044f\u0434\u043a\u043e\u0432\u044b\u0439 (\u0432 \u043f\u0440\u0435\u0434\u0435\u043b\u0430\u0445 \u043e\u0440\u0433\u0430\u043d\u0438\u0437\u0430\u0446\u0438\u0438)'), ('year_month_cemetery', '\u0413\u043e\u0434 + \u043c\u0435\u0441\u044f\u0446 + \u043f\u043e\u0440\u044f\u0434\u043a\u043e\u0432\u044b\u0439 (\u0432 \u043f\u0440\u0435\u0434\u0435\u043b\u0430\u0445 \u043a\u043b\u0430\u0434\u0431\u0438\u0449\u0430)')])),
                ('opf_burial', models.CharField(default='org', max_length=255, verbose_name='\u0417\u0430\u044f\u0432\u0438\u0442\u0435\u043b\u044c \u043f\u043e \u0443\u043c\u043e\u043b\u0447\u0430\u043d\u0438\u044e \u0432 \u0437\u0430\u0445\u043e\u0440\u043e\u043d\u0435\u043d\u0438\u0438', choices=[('org', '\u042e\u041b'), ('person', '\u0424\u041b')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(unique=True, max_length=255, verbose_name='\u041d\u0430\u0437\u0432\u0430\u043d\u0438\u0435', choices=[('trade', '\u0422\u043e\u0440\u0433\u043e\u0432\u043b\u044f'), ('personal-data', '\u041f\u0435\u0440\u0441\u043e\u043d\u0430\u043b\u044c\u043d\u044b\u0435 \u0434\u0430\u043d\u043d\u044b\u0435')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dt_created', models.DateTimeField(auto_now_add=True, verbose_name='\u0414\u0430\u0442\u0430/\u0432\u0440\u0435\u043c\u044f \u0441\u043e\u0437\u0434\u0430\u043d\u0438\u044f')),
                ('dt_modified', models.DateTimeField(auto_now=True, verbose_name='\u0414\u0430\u0442\u0430/\u0432\u0440\u0435\u043c\u044f \u043c\u043e\u0434\u0438\u0444\u0438\u043a\u0430\u0446\u0438\u0438')),
                ('status', models.CharField(verbose_name='\u0421\u0442\u0430\u0442\u0443\u0441 \u0437\u0430\u044f\u0432\u043a\u0438', max_length=255, editable=False, choices=[('to_confirm', '\u041e\u0436\u0438\u0434\u0430\u043d\u0438\u0435 \u043f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043d\u0438\u044f'), ('confirmed', '\u0417\u0430\u044f\u0432\u043a\u0430 \u043f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043d\u0430'), ('declined', '\u0412 \u0440\u0435\u0433\u0438\u0441\u0442\u0440\u0430\u0446\u0438\u0438 \u043e\u0442\u043a\u0430\u0437\u0430\u043d\u043e'), ('approved', '\u041f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u044c \u0432 \u0441\u0438\u0441\u0442\u0435\u043c\u0435')])),
                ...
                ('user_password', models.CharField(default='', verbose_name='\u041f\u0430\u0440\u043e\u043b\u044c', max_length=255, editable=False)),
                ('user_activation_key', models.CharField(verbose_name='\u041a\u043b\u044e\u0447 \u0430\u043a\u0442\u0438\u0432\u0430\u0446\u0438\u0438', max_length=40, editable=False)),
                ('org_type', models.CharField(default='ugh', max_length=255, verbose_name='\u0422\u0438\u043f \u043e\u0440\u0433\u0430\u043d\u0438\u0437\u0430\u0446\u0438\u0438', choices=[('ugh', '\u0423\u0447\u0435\u0442 \u0437\u0430\u0445\u043e\u0440\u043e\u043d\u0435\u043d\u0438\u0439'), ('loru', '\u0423\u0447\u0435\u0442 \u0437\u0430\u043a\u0430\u0437\u043e\u0432')])),
                ('org_name', models.CharField(default='', max_length=255, verbose_name='\u041a\u0440\u0430\u0442\u043a\u043e\u0435 \u043d\u0430\u0437\u0432\u0430\u043d\u0438\u0435 \u043e\u0440\u0433\u0430\u043d\u0438\u0437\u0430\u0446\u0438\u0438')),
                ('org_full_name', models.CharField(default='', max_length=255, verbose_name='\u041f\u043e\u043b\u043d\u043e\u0435 \u043d\u0430\u0437\u0432\u0430\u043d\u0438\u0435 \u043e\u0440\u0433\u0430\u043d\u0438\u0437\u0430\u0446\u0438\u0438')),
                ('org_inn', models.CharField(default='', max_length=255, verbose_name='\u0418\u041d\u041d')),
                ('org_ogrn', models.CharField(default='', max_length=255, verbose_name='\u041e\u0413\u0420\u041d/\u041e\u0413\u0420\u042e\u041b', blank=True)),
                ('org_director', models.CharField(default='', max_length=255, verbose_name='\u0414\u0438\u0440\u0435\u043a\u0442\u043e\u0440')),
                ('org_basis', models.CharField(default='charter', max_length=255, verbose_name='\u041e\u0441\u043d\u043e\u0432\u0430\u043d\u0438\u0435 \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u044f \u0434\u0438\u0440\u0435\u043a\u0442\u043e\u0440\u0430', choices=[('charter', '\u0443\u0441\u0442\u0430\u0432\u0430'), ('condition', '\u043f\u043e\u043b\u043e\u0436\u0435\u043d\u0438\u044f'), ('certificate', '\u0441\u0432\u0438\u0434\u0435\u0442\u0435\u043b\u044c\u0441\u0442\u0432\u0430'), ('proxy', '\u0434\u043e\u0432\u0435\u0440\u0435\u043d\u043d\u043e\u0441\u0442\u0438')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(default='', max_length=255, verbose_name='URL')),
                ('title', models.CharField(default='', max_length=255, verbose_name='\u0417\u0430\u0433\u043e\u043b\u043e\u0432\u043e\u043a')),
                ('title_photo_url', models.URLField(default='', max_length=255, verbose_name='Preview URL')),
