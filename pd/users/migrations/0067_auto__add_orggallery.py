...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrgGallery'
        db.create_table('users_orggallery', (
        ...
        db.send_create_signal('users', ['OrgGallery'])


    def backwards(self, orm):
        # Deleting model 'OrgGallery'
        db.delete_table('users_orggallery')
