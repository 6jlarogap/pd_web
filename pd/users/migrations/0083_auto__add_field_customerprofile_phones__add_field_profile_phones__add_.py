...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerProfile.phones'
        db.add_column('users_customerprofile', 'phones',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.phones'
        db.add_column('users_profile', 'phones',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.title'
        db.add_column('users_profile', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerProfile.phones'
        db.delete_column('users_customerprofile', 'phones')

        # Deleting field 'Profile.phones'
        db.delete_column('users_profile', 'phones')
