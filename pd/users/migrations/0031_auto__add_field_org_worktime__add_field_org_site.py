...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Org.worktime'
        db.add_column('users_org', 'worktime',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Org.site'
        db.add_column('users_org', 'site',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Org.worktime'
        db.delete_column('users_org', 'worktime')

        # Deleting field 'Org.site'
        db.delete_column('users_org', 'site')
