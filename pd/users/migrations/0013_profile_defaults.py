...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('users_profile', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.Country'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.region_fias'
        db.add_column('users_profile', 'region_fias',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.cemetery'
        db.add_column('users_profile', 'cemetery',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.Cemetery'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.area'
        db.add_column('users_profile', 'area',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Profile.region_fias'
        db.delete_column('users_profile', 'region_fias')

        # Deleting field 'Profile.cemetery'
        db.delete_column('users_profile', 'cemetery_id')

        # Deleting field 'Profile.area'
        db.delete_column('users_profile', 'area_id')
