...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Org.plan_date_days_before'
        db.add_column('users_org', 'plan_date_days_before',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Org.plan_date_days_before'
        db.delete_column('users_org', 'plan_date_days_before')
