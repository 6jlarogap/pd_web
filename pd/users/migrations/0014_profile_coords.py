...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.lat'
        db.add_column('users_profile', 'lat',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=30, decimal_places=27, blank=True),
                      keep_default=False)

        # Adding field 'Profile.lng'
        db.add_column('users_profile', 'lng',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=30, decimal_places=27, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.lat'
        db.delete_column('users_profile', 'lat')

        # Deleting field 'Profile.lng'
        db.delete_column('users_profile', 'lng')
