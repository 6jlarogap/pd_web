...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.store'
        db.add_column('users_profile', 'store',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Store'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.store'
        db.delete_column('users_profile', 'store_id')
