...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        print "*** Adding all customerprofile's usernames to customerprofile.login_phone"
        CustomerProfile = orm['users.CustomerProfile']
        for customerprofile in CustomerProfile.objects.all():
            customerprofile.login_phone = decimal.Decimal(customerprofile.user.username)
