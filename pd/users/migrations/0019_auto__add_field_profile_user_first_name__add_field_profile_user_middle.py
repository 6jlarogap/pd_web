...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.user_first_name'
        db.add_column('users_profile', 'user_first_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.user_middle_name'
        db.add_column('users_profile', 'user_middle_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.user_last_name'
        db.add_column('users_profile', 'user_last_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.user_first_name'
        db.delete_column('users_profile', 'user_first_name')

        # Deleting field 'Profile.user_middle_name'
        db.delete_column('users_profile', 'user_middle_name')

        # Deleting field 'Profile.user_last_name'
        db.delete_column('users_profile', 'user_last_name')
