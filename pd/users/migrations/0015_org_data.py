...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_bankaccount', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Org'])),
        ...
        db.send_create_signal('users', ['BankAccount'])

        # Adding field 'Org.kpp'
        db.add_column('users_org', 'kpp',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Org.ogrn'
        db.add_column('users_org', 'ogrn',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Org.off_address'
        db.add_column('users_org', 'off_address',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('users_bankaccount')

        # Deleting field 'Org.kpp'
        db.delete_column('users_org', 'kpp')

        # Deleting field 'Org.ogrn'
        db.delete_column('users_org', 'ogrn')

        # Deleting field 'Org.off_address'
        db.delete_column('users_org', 'off_address_id')
