...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.phones_publish'
        db.add_column('users_profile', 'phones_publish',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.phones_publish'
        db.delete_column('users_profile', 'phones_publish')
    ...
    models = {
        ...
        'users.youtubecaptionvote': {
            'Meta': {'object_name': 'YoutubeCaptionVote'},
            'dt_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'dt_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'like': ('django.db.models.fields.CharField', [], {'default': "'up'", 'max_length': '100'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'youtubecaption': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.YoutubeCaption']"})
        },
        'users.youtubevideo': {
