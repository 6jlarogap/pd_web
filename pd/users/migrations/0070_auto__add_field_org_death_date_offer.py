...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Org.death_date_offer'
        db.add_column('users_org', 'death_date_offer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Org.death_date_offer'
        db.delete_column('users_org', 'death_date_offer')
