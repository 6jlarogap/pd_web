...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrgWebPay'
        db.create_table('users_orgwebpay', (
            ...
            ('org', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['users.Org'], unique=True)),
            ('wsb_storeid', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('secret', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('wsb_store', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('wsb_currency_id', self.gf('django.db.models.fields.CharField')(default='BYR', max_length=255)),
            ('wsb_version', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('wsb_test', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('users', ['OrgWebPay'])


    def backwards(self, orm):
        # Deleting model 'OrgWebPay'
        db.delete_table('users_orgwebpay')
