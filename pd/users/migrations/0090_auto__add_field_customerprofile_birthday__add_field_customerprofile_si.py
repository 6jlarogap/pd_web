...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerProfile.birthday'
        db.add_column('users_customerprofile', 'birthday',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'CustomerProfile.site'
        db.add_column('users_customerprofile', 'site',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Oauth.site'
        db.add_column('users_oauth', 'site',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Profile.birthday'
        db.add_column('users_profile', 'birthday',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Profile.site'
        db.add_column('users_profile', 'site',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerProfile.birthday'
        db.delete_column('users_customerprofile', 'birthday')

        # Deleting field 'CustomerProfile.site'
        db.delete_column('users_customerprofile', 'site')

        # Deleting field 'Oauth.site'
        db.delete_column('users_oauth', 'site')

        # Deleting field 'Profile.birthday'
        db.delete_column('users_profile', 'birthday')

        # Deleting field 'Profile.site'
        db.delete_column('users_profile', 'site')
