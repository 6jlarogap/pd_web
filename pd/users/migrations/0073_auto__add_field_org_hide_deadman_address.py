...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Org.hide_deadman_address'
        db.add_column('users_org', 'hide_deadman_address',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Org.hide_deadman_address'
        db.delete_column('users_org', 'hide_deadman_address')
