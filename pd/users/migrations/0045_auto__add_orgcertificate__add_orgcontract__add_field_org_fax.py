...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrgCertificate'
        db.create_table('users_orgcertificate', (
        ...
        db.send_create_signal('users', ['OrgCertificate'])

        # Adding model 'OrgContract'
        db.create_table('users_orgcontract', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bfile', self.gf('django.db.models.fields.files.FileField')(max_length=100, blank=True)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=96, blank=True)),
            ('original_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal('users', ['OrgContract'])

        # Adding field 'Org.fax'
        db.add_column('users_org', 'fax',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'OrgCertificate'
        db.delete_table('users_orgcertificate')

        # Deleting model 'OrgContract'
        db.delete_table('users_orgcontract')

        # Deleting field 'Org.fax'
        db.delete_column('users_org', 'fax')
