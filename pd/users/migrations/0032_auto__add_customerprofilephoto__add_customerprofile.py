...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CustomerProfilePhoto'
        db.create_table('users_customerprofilephoto', (
            ...
            ('customerprofile', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['users.CustomerProfile'], unique=True)),
        ))
        db.send_create_signal('users', ['CustomerProfilePhoto'])

        # Adding model 'CustomerProfile'
        db.create_table('users_customerprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True)),
            ('user_last_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('user_first_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('user_middle_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('users', ['CustomerProfile'])


    def backwards(self, orm):
        # Deleting model 'CustomerProfilePhoto'
        db.delete_table('users_customerprofilephoto')

        # Deleting model 'CustomerProfile'
        db.delete_table('users_customerprofile')
