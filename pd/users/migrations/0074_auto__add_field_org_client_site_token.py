...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Org.client_site_token'
        db.add_column('users_org', 'client_site_token',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Org.client_site_token'
        db.delete_column('users_org', 'client_site_token')
