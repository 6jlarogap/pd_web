...
urlpatterns = patterns('users.views',
    ...
    url(r'^org/log_org/$', 'org_log_org', name='org_log_org'),
    ...
    url(r'^api/thank/(?P<pk>\d+)/?$', 'api_thank_detail', name='api_thank_detail'),
    ...
    url(r'^api/videos/(?P<yid>\S+)/statistics/current-user-time-votes/?$',
        'api_video_statistics_current_user', name='api_video_statistics_current_user'),
    url(r'^api/videos/(?P<yid>\S+)/subtitles/?$', 'api_video_subtitles', name='api_video_subtitles'),
