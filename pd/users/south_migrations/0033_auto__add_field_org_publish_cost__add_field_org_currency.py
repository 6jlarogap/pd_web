...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('users_org', 'currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['billing.Currency']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Org.publish_cost'
        db.delete_column('users_org', 'publish_cost')

        # Deleting field 'Org.currency'
        db.delete_column('users_org', 'currency_id')
