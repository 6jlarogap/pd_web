...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Dover.org'
        db.delete_column('users_dover', 'org_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Dover.org'
        raise RuntimeError("Cannot reverse this migration. 'Dover.org' and its values cannot be restored.")
