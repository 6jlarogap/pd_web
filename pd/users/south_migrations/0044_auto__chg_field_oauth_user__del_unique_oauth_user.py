...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Oauth', fields ['user']
        db.delete_unique('users_oauth', ['user_id'])


        # Changing field 'Oauth.user'
        db.alter_column('users_oauth', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Oauth.user'
        db.alter_column('users_oauth', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'Oauth', fields ['user']
        db.create_unique('users_oauth', ['user_id'])
