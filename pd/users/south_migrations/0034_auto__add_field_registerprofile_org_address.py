...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegisterProfile.org_address'
        db.add_column('users_registerprofile', 'org_address',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.Location'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegisterProfile.org_address'
        db.delete_column('users_registerprofile', 'org_address_id')
