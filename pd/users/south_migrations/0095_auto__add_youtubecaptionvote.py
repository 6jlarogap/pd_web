...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'YoutubeCaptionVote'
        db.create_table('users_youtubecaptionvote', (
            ...
            ('youtubecaption', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.YoutubeCaption'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('like', self.gf('django.db.models.fields.CharField')(default='up', max_length=100)),
        ))
        db.send_create_signal('users', ['YoutubeCaptionVote'])


    def backwards(self, orm):
        # Deleting model 'YoutubeCaptionVote'
        db.delete_table('users_youtubecaptionvote')
