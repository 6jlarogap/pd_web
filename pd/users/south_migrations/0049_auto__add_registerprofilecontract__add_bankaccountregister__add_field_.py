...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RegisterProfileContract'
        db.create_table('users_registerprofilecontract', (
        ...
        db.send_create_signal('users', ['RegisterProfileContract'])

        # Adding model 'BankAccountRegister'
        db.create_table('users_bankaccountregister', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('registerprofile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.RegisterProfile'])),
        ))
        db.send_create_signal('users', ['BankAccountRegister'])

        # Adding field 'RegisterProfile.org_ogrn'
        db.add_column('users_registerprofile', 'org_ogrn',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'RegisterProfile.org_basis'
        db.add_column('users_registerprofile', 'org_basis',
                      self.gf('django.db.models.fields.CharField')(default='charter', max_length=255),
                      keep_default=False)

        # Adding field 'RegisterProfile.org_fax'
        db.add_column('users_registerprofile', 'org_fax',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'RegisterProfileContract'
        db.delete_table('users_registerprofilecontract')

        # Deleting model 'BankAccountRegister'
        db.delete_table('users_bankaccountregister')

        # Deleting field 'RegisterProfile.org_ogrn'
        db.delete_column('users_registerprofile', 'org_ogrn')

        # Deleting field 'RegisterProfile.org_basis'
        db.delete_column('users_registerprofile', 'org_basis')

        # Deleting field 'RegisterProfile.org_fax'
        db.delete_column('users_registerprofile', 'org_fax')
