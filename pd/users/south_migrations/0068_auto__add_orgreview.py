...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrgReview'
        db.create_table('users_orgreview', (
            ...
            ('common_text', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('positive_text', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('negative_text', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], on_delete=models.PROTECT)),
        ))
        db.send_create_signal('users', ['OrgReview'])


    def backwards(self, orm):
        # Deleting model 'OrgReview'
        db.delete_table('users_orgreview')
