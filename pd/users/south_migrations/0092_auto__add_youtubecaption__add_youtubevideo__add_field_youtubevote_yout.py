...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'YoutubeCaption'
        db.create_table('users_youtubecaption', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('youtubevideo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.YoutubeVideo'])),
        ...
        db.send_create_signal('users', ['YoutubeCaption'])

        # Adding model 'YoutubeVideo'
        db.create_table('users_youtubevideo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('yid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('url', self.gf('django.db.models.fields.URLField')(default='', max_length=255)),
            ('title', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('title_photo_url', self.gf('django.db.models.fields.URLField')(default='', max_length=255)),
        ))
        db.send_create_signal('users', ['YoutubeVideo'])

        # Adding field 'YoutubeVote.youtubevideo'
        db.add_column('users_youtubevote', 'youtubevideo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.YoutubeVideo'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'YoutubeCaption'
        db.delete_table('users_youtubecaption')

        # Deleting model 'YoutubeVideo'
        db.delete_table('users_youtubevideo')

        # Deleting field 'YoutubeVote.youtubevideo'
        db.delete_column('users_youtubevote', 'youtubevideo_id')
    ...
    models = {
        ...
        'users.storephoto': {
            ...
            'original_filename': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'photo': ('django.db.models.fields.files.ImageField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'store': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['users.Store']", 'unique': 'True'})
        },
        'users.thank': {
            'Meta': {'unique_together': "(('user', 'customperson'),)", 'object_name': 'Thank'},
        ...
        'users.thankuser': {
            'Meta': {'object_name': 'ThankUser'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login_phone': ('django.db.models.fields.DecimalField', [], {'unique': 'True', 'max_digits': '15', 'decimal_places': '0'}),
        ...
        'users.youtubecaption': {
            'Meta': {'object_name': 'YoutubeCaption'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'users.youtubevideo': {
            ...
            'title_photo_url': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '255'}),
            'url': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '255'}),
            'yid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'})
        },
        'users.youtubevote': {
            'Meta': {'object_name': 'YoutubeVote'},
            'dt_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'dt_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
