...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegisterProfile.org_subdomain'
        db.add_column('users_registerprofile', 'org_subdomain',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Org.subdomain'
        db.add_column('users_org', 'subdomain',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding unique constraint on 'Org', fields ['subdomain']
        db.create_unique('users_org', ['subdomain'])


    def backwards(self, orm):
        # Removing unique constraint on 'Org', fields ['subdomain']
        db.delete_unique('users_org', ['subdomain'])

        # Deleting field 'RegisterProfile.org_subdomain'
        db.delete_column('users_registerprofile', 'org_subdomain')

        # Deleting field 'Org.subdomain'
        db.delete_column('users_org', 'subdomain')
