...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FavoriteSupplier'
        db.create_table('users_favoritesupplier', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('loru', self.gf('django.db.models.fields.related.ForeignKey')(related_name='favorite_loru', on_delete=models.PROTECT, to=orm['users.Org'])),
            ('supplier', self.gf('django.db.models.fields.related.ForeignKey')(related_name='favorite_supplier_list', on_delete=models.PROTECT, to=orm['users.Org'])),
        ))
        db.send_create_signal('users', ['FavoriteSupplier'])

        # Adding unique constraint on 'FavoriteSupplier', fields ['loru', 'supplier']
        db.create_unique('users_favoritesupplier', ['loru_id', 'supplier_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'FavoriteSupplier', fields ['loru', 'supplier']
        db.delete_unique('users_favoritesupplier', ['loru_id', 'supplier_id'])

        # Deleting model 'FavoriteSupplier'
        db.delete_table('users_favoritesupplier')
