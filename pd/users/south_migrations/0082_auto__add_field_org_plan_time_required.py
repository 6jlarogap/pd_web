...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Org.plan_time_required'
        db.add_column('users_org', 'plan_time_required',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Org.plan_time_required'
        db.delete_column('users_org', 'plan_time_required')
