...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerProfile.tc_confirmed'
        db.add_column('users_customerprofile', 'tc_confirmed',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 4, 16, 0, 0), null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerProfile.tc_confirmed'
        db.delete_column('users_customerprofile', 'tc_confirmed')
    ...
    models = {
        ...
        'users.customerprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tc_confirmed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 16, 0, 0)', 'null': 'True'}),
