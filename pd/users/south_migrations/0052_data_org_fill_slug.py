...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        Org = orm['users.Org']
        for o in Org.objects.filter(slug__isnull=True):
            o.save()
    ...
    models = {
        ...
        'users.org': {
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'max_length': '255', 'unique': 'True', 'null': 'True', 'populate_from': "'name'", 'unique_with': '()', 'blank': 'True'}),
