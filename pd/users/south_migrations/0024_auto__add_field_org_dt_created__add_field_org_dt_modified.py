...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Org.dt_created'
        db.add_column('users_org', 'dt_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 16, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Org.dt_modified'
        db.add_column('users_org', 'dt_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 9, 16, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Org.dt_created'
        db.delete_column('users_org', 'dt_created')

        # Deleting field 'Org.dt_modified'
        db.delete_column('users_org', 'dt_modified')
