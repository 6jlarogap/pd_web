...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'YoutubeVideo.is_hidden'
        db.add_column('users_youtubevideo', 'is_hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'YoutubeVideo.is_hidden'
        db.delete_column('users_youtubevideo', 'is_hidden')
