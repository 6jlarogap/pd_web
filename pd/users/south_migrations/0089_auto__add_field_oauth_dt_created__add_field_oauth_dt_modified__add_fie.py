...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('users_oauth', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Oauth.photo'
        db.add_column('users_oauth', 'photo',
    ...
    def backwards(self, orm):
        # Deleting field 'Oauth.dt_created'
        db.delete_column('users_oauth', 'dt_created')

        # Deleting field 'Oauth.dt_modified'
        db.delete_column('users_oauth', 'dt_modified')

        # Deleting field 'Oauth.email'
        db.delete_column('users_oauth', 'email')

        # Deleting field 'Oauth.photo'
        db.delete_column('users_oauth', 'photo')
