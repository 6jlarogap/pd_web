...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BankAccount.off_address'
        db.add_column('users_bankaccount', 'off_address',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.Location'], null=True),
                      keep_default=False)

        # Adding field 'BankAccountRegister.off_address'
        db.add_column('users_bankaccountregister', 'off_address',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.Location'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BankAccount.off_address'
        db.delete_column('users_bankaccount', 'off_address_id')

        # Deleting field 'BankAccountRegister.off_address'
        db.delete_column('users_bankaccountregister', 'off_address_id')
