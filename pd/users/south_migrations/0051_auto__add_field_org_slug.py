...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Org.slug'
        db.add_column('users_org', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(max_length=255, unique=True, null=True, populate_from='name', unique_with=()),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Org.slug'
        db.delete_column('users_org', 'slug')
