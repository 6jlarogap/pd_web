...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_userphoto', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='user_photo_list', unique=True, to=orm['auth.User'])),
        ))
        db.send_create_signal('users', ['UserPhoto'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('users_userphoto')
