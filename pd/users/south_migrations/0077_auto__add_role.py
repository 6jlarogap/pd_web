...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_profile_role', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profile', models.ForeignKey(orm['users.profile'], null=False)),
            ('role', models.ForeignKey(orm['users.role'], null=False))
        ))
        db.create_unique('users_profile_role', ['profile_id', 'role_id'])

        # Adding M2M table for field cemeteries on 'Profile'
        db.create_table('users_profile_cemeteries', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profile', models.ForeignKey(orm['users.profile'], null=False)),
            ('cemetery', models.ForeignKey(orm['burials.cemetery'], null=False))
        ))
        db.create_unique('users_profile_cemeteries', ['profile_id', 'cemetery_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('users_profile_role')

        # Removing M2M table for field cemeteries on 'Profile'
        db.delete_table('users_profile_cemeteries')
