...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Oauth.last_name'
        db.add_column('users_oauth', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Oauth.first_name'
        db.add_column('users_oauth', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Oauth.display_name'
        db.add_column('users_oauth', 'display_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Oauth.last_name'
        db.delete_column('users_oauth', 'last_name')

        # Deleting field 'Oauth.first_name'
        db.delete_column('users_oauth', 'first_name')

        # Deleting field 'Oauth.display_name'
        db.delete_column('users_oauth', 'display_name')
