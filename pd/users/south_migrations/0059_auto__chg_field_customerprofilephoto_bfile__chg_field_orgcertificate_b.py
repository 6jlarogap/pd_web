...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CustomerProfilePhoto.bfile'
        db.alter_column('users_customerprofilephoto', 'bfile', self.gf('django.db.models.fields.files.FileField')(max_length=255))

        # Changing field 'OrgCertificate.bfile'
        db.alter_column('users_orgcertificate', 'bfile', self.gf('django.db.models.fields.files.FileField')(max_length=255))

        # Changing field 'OrgContract.bfile'
        db.alter_column('users_orgcontract', 'bfile', self.gf('django.db.models.fields.files.FileField')(max_length=255))

        # Changing field 'RegisterProfileScan.bfile'
        db.alter_column('users_registerprofilescan', 'bfile', self.gf('django.db.models.fields.files.FileField')(max_length=255))

        # Changing field 'RegisterProfileContract.bfile'
        db.alter_column('users_registerprofilecontract', 'bfile', self.gf('django.db.models.fields.files.FileField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'CustomerProfilePhoto.bfile'
        db.alter_column('users_customerprofilephoto', 'bfile', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'OrgCertificate.bfile'
        db.alter_column('users_orgcertificate', 'bfile', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'OrgContract.bfile'
        db.alter_column('users_orgcontract', 'bfile', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'RegisterProfileScan.bfile'
        db.alter_column('users_registerprofilescan', 'bfile', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'RegisterProfileContract.bfile'
        db.alter_column('users_registerprofilecontract', 'bfile', self.gf('django.db.models.fields.files.FileField')(max_length=100))
