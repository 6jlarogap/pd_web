...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Org.full_name'
        db.add_column('users_org', 'full_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Org.inn'
        db.add_column('users_org', 'inn',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Org.director'
        db.add_column('users_org', 'director',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Org.full_name'
        db.delete_column('users_org', 'full_name')

        # Deleting field 'Org.inn'
        db.delete_column('users_org', 'inn')

        # Deleting field 'Org.director'
        db.delete_column('users_org', 'director')
