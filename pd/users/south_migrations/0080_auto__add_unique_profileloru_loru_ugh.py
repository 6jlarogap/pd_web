...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ProfileLORU', fields ['loru', 'ugh']
        db.create_unique('users_profileloru', ['loru_id', 'ugh_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProfileLORU', fields ['loru', 'ugh']
        db.delete_unique('users_profileloru', ['loru_id', 'ugh_id'])
