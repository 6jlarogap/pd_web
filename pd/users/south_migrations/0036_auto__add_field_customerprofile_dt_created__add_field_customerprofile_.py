...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerProfile.dt_created'
        db.add_column('users_customerprofile', 'dt_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 4, 25, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'CustomerProfile.dt_modified'
        db.add_column('users_customerprofile', 'dt_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 4, 25, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Profile.dt_created'
        db.add_column('users_profile', 'dt_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 4, 25, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Profile.dt_modified'
        db.add_column('users_profile', 'dt_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 4, 25, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerProfile.dt_created'
        db.delete_column('users_customerprofile', 'dt_created')

        # Deleting field 'CustomerProfile.dt_modified'
        db.delete_column('users_customerprofile', 'dt_modified')

        # Deleting field 'Profile.dt_created'
        db.delete_column('users_profile', 'dt_created')

        # Deleting field 'Profile.dt_modified'
        db.delete_column('users_profile', 'dt_modified')
