...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Org.opf_order_customer_mandatory'
        db.add_column('users_org', 'opf_order_customer_mandatory',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Org.opf_order_customer_mandatory'
        db.delete_column('users_org', 'opf_order_customer_mandatory')
