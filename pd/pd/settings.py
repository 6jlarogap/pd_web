...
# Делалась миграция, при которой продукты из категории "Комплектующие"
# переводились в "Прочие" и им присваивался признак комплектующие.
# Пользователи должны раскидать эти комплектующие по разным
# категориям. Пока не раскидали (или пока мы не посчитаем, что
# они раскидали :), надо их предупреждать, чтоб раскидали.
# Потом в этой константе не будет необходимости
#
