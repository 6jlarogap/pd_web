...
from orders.views import ProductCategoryViewSet, CatalogFiltersViewSet, ProductViewSet, ProductInfoViewSet
...
router.register(r'^api/product/(?P<id>.*)$', ProductInfoViewSet)
