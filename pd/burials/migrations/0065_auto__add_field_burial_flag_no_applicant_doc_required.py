...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Burial.flag_no_applicant_doc_required'
        db.add_column('burials_burial', 'flag_no_applicant_doc_required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Burial.flag_no_applicant_doc_required'
        db.delete_column('burials_burial', 'flag_no_applicant_doc_required')
