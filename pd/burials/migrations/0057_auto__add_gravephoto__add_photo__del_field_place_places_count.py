...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('burials', ['Photo'])

        # Deleting field 'Place.places_count'
        db.delete_column('burials_place', 'places_count')
    ...
    def backwards(self, orm):
        ...
        db.delete_table('burials_photo')

        # Adding field 'Place.places_count'
        db.add_column('burials_place', 'places_count',
