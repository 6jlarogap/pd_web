...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.dt_created'
        db.add_column('burials_place', 'dt_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Place.dt_modified'
        db.add_column('burials_place', 'dt_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 9, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Grave.dt_created'
        db.add_column('burials_grave', 'dt_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Grave.dt_modified'
        db.add_column('burials_grave', 'dt_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 9, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Area.dt_created'
        db.add_column('burials_area', 'dt_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Area.dt_modified'
        db.add_column('burials_area', 'dt_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 9, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PlaceStatus.dt_created'
        db.add_column('burials_placestatus', 'dt_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PlaceStatus.dt_modified'
        db.add_column('burials_placestatus', 'dt_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 9, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Cemetery.dt_created'
        db.add_column('burials_cemetery', 'dt_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Cemetery.dt_modified'
        db.add_column('burials_cemetery', 'dt_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 9, 13, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.dt_created'
        db.delete_column('burials_place', 'dt_created')

        # Deleting field 'Place.dt_modified'
        db.delete_column('burials_place', 'dt_modified')

        # Deleting field 'Grave.dt_created'
        db.delete_column('burials_grave', 'dt_created')

        # Deleting field 'Grave.dt_modified'
        db.delete_column('burials_grave', 'dt_modified')

        # Deleting field 'Area.dt_created'
        db.delete_column('burials_area', 'dt_created')

        # Deleting field 'Area.dt_modified'
        db.delete_column('burials_area', 'dt_modified')

        # Deleting field 'PlaceStatus.dt_created'
        db.delete_column('burials_placestatus', 'dt_created')

        # Deleting field 'PlaceStatus.dt_modified'
        db.delete_column('burials_placestatus', 'dt_modified')

        # Deleting field 'Cemetery.dt_created'
        db.delete_column('burials_cemetery', 'dt_created')

        # Deleting field 'Cemetery.dt_modified'
        db.delete_column('burials_cemetery', 'dt_modified')
