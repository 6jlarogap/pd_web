...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Grave', fields ['grave_number', 'place']
        db.create_unique('burials_grave', ['grave_number', 'place_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Grave', fields ['grave_number', 'place']
        db.delete_unique('burials_grave', ['grave_number', 'place_id'])
