    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('burial_type', models.CharField(max_length=255, null=True, verbose_name='\u0412\u0438\u0434 \u0437\u0430\u0445\u043e\u0440\u043e\u043d\u0435\u043d\u0438\u044f')),
                ('burial_container', models.CharField(max_length=255, null=True, verbose_name='\u0422\u0438\u043f \u0437\u0430\u0445\u043e\u0440\u043e\u043d\u0435\u043d\u0438\u044f')),
                ('source_type', models.CharField(max_length=255, null=True, verbose_name='\u0418\u0441\u0442\u043e\u0447\u043d\u0438\u043a')),
                ('account_number', models.CharField(max_length=255, null=True, verbose_name='\u2116 \u0432 \u043a\u043d\u0438\u0433\u0435 \u0443\u0447\u0435\u0442\u0430')),
                ...
                ('row', models.CharField(max_length=255, verbose_name='\u0420\u044f\u0434')),
                ('place_number', models.CharField(max_length=255, verbose_name='\u041d\u043e\u043c\u0435\u0440 \u043c\u0435\u0441\u0442\u0430')),
                ...
                ('place_length', models.DecimalField(null=True, verbose_name='\u0414\u043b\u0438\u043d\u0430, \u043c.', max_digits=5, decimal_places=2)),
                ('place_width', models.DecimalField(null=True, verbose_name='\u0428\u0438\u0440\u0438\u043d\u0430, \u043c.', max_digits=5, decimal_places=2)),
                ('plan_date', models.DateField(null=True, verbose_name='\u041f\u043b\u0430\u043d. \u0434\u0430\u0442\u0430')),
                ('plan_time', models.TimeField(null=True, verbose_name='\u041f\u043b\u0430\u043d. \u0432\u0440\u0435\u043c\u044f')),
                ...
                ('fact_date', pd.models.UnclearDateModelField(null=True, verbose_name='\u0424\u0430\u043a\u0442. \u0434\u0430\u0442\u0430')),
                ('fact_date_s', models.CharField(max_length=255, verbose_name='\u0424\u0430\u043a\u0442. \u0434\u0430\u0442\u0430')),
                ...
                ('flag_no_applicant_doc_required', models.BooleanField(default=False, verbose_name='\u0414\u043e\u043a\u0443\u043c\u0435\u043d\u0442 \u0437\u0430\u044f\u0432\u0438\u0442\u0435\u043b\u044f-\u0424\u041b \u043d\u0435 \u0442\u0440\u0435\u0431\u0443\u0435\u0442\u0441\u044f')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('availability', models.CharField(default='open', max_length=32, verbose_name='\u041e\u0442\u043a\u0440\u044b\u0442\u043e\u0441\u0442\u044c', choices=[('open', '\u041e\u0442\u043a\u0440\u044b\u0442'), ('old_only', '\u0422\u043e\u043b\u044c\u043a\u043e \u043f\u043e\u0434\u0437\u0430\u0445\u043e\u0440\u043e\u043d\u0435\u043d\u0438\u044f'), ('closed', '\u0417\u0430\u043a\u0440\u044b\u0442')])),
                ('kind', models.CharField(default='g', max_length=8, verbose_name='\u0422\u0438\u043f', choices=[('g', '\u041a\u043b\u0430\u0434\u0431\u0438\u0449\u0435\u043d\u0441\u043a\u0438\u0439 (\u041c\u043e\u0433\u0438\u043b\u044b)'), ('v', '\u041a\u043e\u043b\u0443\u043c\u0431\u0430\u0440\u043d\u0430\u044f \u0441\u0442\u0435\u043d\u0430'), ('h', '\u0413\u043e\u0440\u0438\u0437\u043e\u043d\u0442\u0430\u043b\u044c\u043d\u044b\u0439 \u043a\u043e\u043b\u0443\u043c\u0431\u0430\u0440\u0438\u0439')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dt_created', models.DateTimeField(auto_now_add=True, verbose_name='\u0414\u0430\u0442\u0430/\u0432\u0440\u0435\u043c\u044f \u0441\u043e\u0437\u0434\u0430\u043d\u0438\u044f')),
                ('dt_modified', models.DateTimeField(auto_now=True, verbose_name='\u0414\u0430\u0442\u0430/\u0432\u0440\u0435\u043c\u044f \u043c\u043e\u0434\u0438\u0444\u0438\u043a\u0430\u0446\u0438\u0438')),
                ('burial_type', models.CharField(default='common', choices=[('common', '\u041d\u043e\u0432\u043e\u0435 \u0437\u0430\u0445\u043e\u0440\u043e\u043d\u0435\u043d\u0438\u0435'), ('additional', '\u041f\u043e\u0434\u0437\u0430\u0445\u043e\u0440\u043e\u043d\u0435\u043d\u0438\u0435'), ('overlap', '\u0417\u0430\u0445\u043e\u0440\u043e\u043d\u0435\u043d\u0438\u0435 \u0432 \u0441\u0443\u0449\u0435\u0441\u0442\u0432\u0443\u044e\u0449\u0443\u044e')], max_length=255, blank=True, null=True, verbose_name='\u0412\u0438\u0434 \u0437\u0430\u0445\u043e\u0440\u043e\u043d\u0435\u043d\u0438\u044f')),
                ('burial_container', models.CharField(default='container_coffin', choices=[('container_coffin', '\u0413\u0440\u043e\u0431'), ('container_urn', '\u0423\u0440\u043d\u0430'), ('container_ash', '\u041f\u0440\u0430\u0445'), ('container_bio', '\u0411\u0438\u043e\u043e\u0442\u0445\u043e\u0434\u044b')], max_length=255, blank=True, null=True, verbose_name='\u0422\u0438\u043f \u0437\u0430\u0445\u043e\u0440\u043e\u043d\u0435\u043d\u0438\u044f')),
                ('source_type', models.CharField(verbose_name='\u0418\u0441\u0442\u043e\u0447\u043d\u0438\u043a', max_length=255, null=True, editable=False, choices=[('full', '\u042d\u043b\u0435\u043a\u0442\u0440\u043e\u043d\u043d\u043e\u0435'), ('ugh', '\u0420\u0443\u0447\u043d\u043e\u0435'), ('archive', '\u0410\u0440\u0445\u0438\u0432\u043d\u043e\u0435'), ('transferred', '\u041f\u0435\u0440\u0435\u043d\u0435\u0441\u0435\u043d\u043d\u043e\u0435')])),
                ('account_number', models.CharField(max_length=255, null=True, verbose_name='\u2116 \u0432 \u043a\u043d\u0438\u0433\u0435 \u0443\u0447\u0435\u0442\u0430', blank=True)),
                ('row', models.CharField(default='', max_length=255, verbose_name='\u0420\u044f\u0434', blank=True)),
                ('place_number', models.CharField(default='', help_text='\u0415\u0441\u043b\u0438 \u043f\u0443\u0441\u0442\u043e - \u043d\u043e\u043c\u0435\u0440 \u0431\u0443\u0434\u0435\u0442 \u0441\u0433\u0435\u043d\u0435\u0440\u0438\u0440\u043e\u0432\u0430\u043d \u0430\u0432\u0442\u043e\u043c\u0430\u0442\u0438\u0447\u0435\u0441\u043a\u0438', max_length=255, verbose_name='\u041d\u043e\u043c\u0435\u0440 \u043c\u0435\u0441\u0442\u0430', blank=True)),
                ('grave_number', models.PositiveSmallIntegerField(default=1, verbose_name='\u041c\u043e\u0433\u0438\u043b\u0430')),
                ('desired_graves_count', models.PositiveSmallIntegerField(default=1, verbose_name='\u0427\u0438\u0441\u043b\u043e \u043c\u043e\u0433\u0438\u043b \u0432 \u043d\u043e\u0432\u043e\u043c \u043c\u0435\u0441\u0442\u0435')),
                ...
                ('loru_agent_director', models.BooleanField(default=False, verbose_name='\u0414\u0438\u0440\u0435\u043a\u0442\u043e\u0440-\u0410\u0433\u0435\u043d\u0442')),
                ('agent_director', models.BooleanField(default=False, verbose_name='\u0414\u0438\u0440\u0435\u043a\u0442\u043e\u0440-\u0410\u0433\u0435\u043d\u0442')),
                ('status', models.CharField(default='draft', verbose_name='\u0421\u0442\u0430\u0442\u0443\u0441', max_length=255, editable=False, choices=[('backed', '\u041e\u0442\u043e\u0437\u0432\u0430\u043d\u043e'), ('declined', '\u041e\u0442\u043a\u043b\u043e\u043d\u0435\u043d\u043e'), ('draft', '\u0427\u0435\u0440\u043d\u043e\u0432\u0438\u043a'), ('ready', '\u041d\u0430 \u0441\u043e\u0433\u043b\u0430\u0441\u043e\u0432\u0430\u043d\u0438\u0438'), ('inspecting', '\u041d\u0430 \u043e\u0431\u0441\u043b\u0435\u0434\u043e\u0432\u0430\u043d\u0438\u0438'), ('approved', '\u0421\u043e\u0433\u043b\u0430\u0441\u043e\u0432\u0430\u043d\u043e'), ('closed', '\u0417\u0430\u043a\u0440\u044b\u0442\u043e'), ('exhumated', '\u042d\u043a\u0441\u0433\u0443\u043c\u0438\u0440\u043e\u0432\u0430\u043d\u043e')])),
                ('annulated', models.BooleanField(default=False, verbose_name='\u0410\u043d\u043d\u0443\u043b\u0438\u0440\u043e\u0432\u0430\u043d\u043e')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('places_algo', models.CharField(default='manual', max_length=255, verbose_name='\u0420\u0430\u0441\u0441\u0442\u0430\u043d\u043e\u0432\u043a\u0430 \u043d\u043e\u043c\u0435\u0440\u043e\u0432 \u043c\u0435\u0441\u0442 \u043d\u043e\u0432\u044b\u0445 \u0440\u0443\u0447\u043d\u044b\u0445 \u0438 \u044d\u043b\u0435\u043a\u0442\u0440\u043e\u043d\u043d\u044b\u0445 \u0437\u0430\u0445\u043e\u0440\u043e\u043d\u0435\u043d\u0438\u0439', choices=[('area', '\u041f\u043e \u0443\u0447\u0430\u0441\u0442\u043a\u0443'), ('row', '\u041f\u043e \u0440\u044f\u0434\u0443'), ('cem_year', '\u041a\u043b\u0430\u0434\u0431\u0438\u0449\u0435 + \u0433\u043e\u0434'), ('burial_account_number', '\u041f\u043e \u0440\u0435\u0433. \u043d\u043e\u043c\u0435\u0440\u0443 \u0437\u0430\u0445\u043e\u0440\u043e\u043d\u0435\u043d\u0438\u044f'), ('manual', '\u0412\u0440\u0443\u0447\u043d\u0443\u044e')])),
                ('places_algo_archive', models.CharField(default='manual', max_length=255, verbose_name='\u0420\u0430\u0441\u0441\u0442\u0430\u043d\u043e\u0432\u043a\u0430 \u043d\u043e\u043c\u0435\u0440\u043e\u0432 \u0441\u0443\u0449\u0435\u0441\u0442\u0432\u0443\u044e\u0449\u0438\u0445, \u043d\u043e \u043d\u0435\u0443\u0447\u0442\u0435\u043d\u043d\u044b\u0445 \u043c\u0435\u0441\u0442', choices=[('manual', '\u0412\u0440\u0443\u0447\u043d\u0443\u044e'), ('-area', '\u041f\u043e \u043f\u043e\u0440\u044f\u0434\u043a\u0443 \u0432 \u043f\u0440\u0435\u0434\u0435\u043b\u0430\u0445 \u0443\u0447\u0430\u0441\u0442\u043a\u0430 (-0001 -0002...)'), ('burial_account_number', '\u041f\u043e \u0440\u0435\u0433. \u043d\u043e\u043c\u0435\u0440\u0443 \u0437\u0430\u0445\u043e\u0440\u043e\u043d\u0435\u043d\u0438\u044f')])),
                ('time_slots', models.TextField(default='', help_text='\u0412 \u0444\u043e\u0440\u043c\u0430\u0442\u0435 \u0427\u0427:\u041c\u041c, \u043f\u043e \u043e\u0434\u043d\u043e\u043c\u0443 \u043d\u0430 \u0441\u0442\u0440\u043e\u043a\u0443', verbose_name='\u0412\u0440\u0435\u043c\u044f \u0434\u043b\u044f \u0437\u0430\u0445\u043e\u0440\u043e\u043d\u0435\u043d\u0438\u044f', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('cemetery_text', models.CharField(default='', max_length=255, verbose_name='\u041a\u043b\u0430\u0434\u0431\u0438\u0449\u0435')),
                ('row', models.CharField(default='', max_length=255, verbose_name='\u0420\u044f\u0434')),
                ('place', models.CharField(default='', max_length=255, verbose_name='\u041c\u0435\u0441\u0442\u043e')),
                ('size', models.CharField(default='', max_length=255, verbose_name='\u0420\u0430\u0437\u043c\u0435\u0440 \u0433\u0440\u043e\u0431\u0430')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('place', models.CharField(default='', max_length=255, verbose_name='\u041c\u0435\u0441\u0442\u043e', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dt_created', models.DateTimeField(auto_now_add=True, verbose_name='\u0414\u0430\u0442\u0430/\u0432\u0440\u0435\u043c\u044f \u0441\u043e\u0437\u0434\u0430\u043d\u0438\u044f')),
                ('dt_modified', models.DateTimeField(auto_now=True, verbose_name='\u0414\u0430\u0442\u0430/\u0432\u0440\u0435\u043c\u044f \u043c\u043e\u0434\u0438\u0444\u0438\u043a\u0430\u0446\u0438\u0438')),
                ('status', models.CharField(default='actual', max_length=40, verbose_name='\u0421\u0442\u0430\u0442\u0443\u0441', choices=[('actual', '\u0414\u0435\u0439\u0441\u0442\u0432\u0443\u044e\u0449\u0435\u0435 \u043c\u0435\u0441\u0442\u043e'), ('found-unowned', '\u041e\u0431\u043d\u0430\u0440\u0443\u0436\u0435\u043d\u043e \u0431\u0435\u0441\u0445\u043e\u0437\u044f\u0439\u043d\u044b\u043c'), ('signed', '\u0423\u0441\u0442\u0430\u043d\u043e\u0432\u043b\u0435\u043d\u0430 \u0442\u0430\u0431\u043b\u0438\u0447\u043a\u0430'), ('responsible-rejected', '\u041e\u0442\u043a\u0430\u0437 \u043e\u0442\u0432\u0435\u0442\u0441\u0442\u0432\u0435\u043d\u043d\u043e\u0433\u043e \u043e\u0442 \u043c\u0435\u0441\u0442\u0430'), ('accepted-unowned', '\u041f\u0440\u0438\u0437\u043d\u0430\u043d\u043e \u0431\u0435\u0441\u0445\u043e\u0437\u044f\u0439\u043d\u044b\u043c'), ('recovering', '\u0413\u043e\u0442\u043e\u0432\u0438\u0442\u0441\u044f \u043a \u043f\u043e\u0432\u0442\u043e\u0440\u043d\u043e\u043c\u0443 \u0438\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u043d\u0438\u044e'), ('recovered', '\u0413\u043e\u0442\u043e\u0432\u043e \u043a \u043f\u043e\u0432\u0442\u043e\u0440\u043d\u043e\u043c\u0443 \u0438\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u043d\u0438\u044e'), ('other', '\u0414\u0440\u0443\u0433\u043e\u0439 \u0441\u0442\u0430\u0442\u0443\u0441 \u043c\u0435\u0441\u0442\u0430')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('reason_type', models.CharField(max_length=255, verbose_name='\u0414\u0435\u0439\u0441\u0442\u0432\u0438\u0435', choices=[('back', '\u041b\u041e\u0420\u0423 \u043e\u0442\u0437\u044b\u0432\u0430\u0435\u0442 \u0437\u0430\u0445\u043e\u0440\u043e\u043d\u0435\u043d\u0438\u0435'), ('decline', '\u041e\u041c\u0421 \u043e\u0442\u043a\u0430\u0437\u044b\u0432\u0430\u0435\u0442 \u0432 \u0437\u0430\u0445\u043e\u0440\u043e\u043d\u0435\u043d\u0438\u0438'), ('annulate', '\u0410\u043d\u043d\u0443\u043b\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u0435 \u0437\u0430\u0445\u043e\u0440\u043e\u043d\u0435\u043d\u0438\u044f'), ('disapprove', '\u041e\u041c\u0421 \u043e\u0442\u0437\u044b\u0432\u0430\u0435\u0442 \u0441\u043e\u0433\u043b\u0430\u0441\u043e\u0432\u0430\u043d\u0438\u0435 \u0440\u0443\u0447\u043d\u043e\u0433\u043e \u0437\u0430\u0445\u043e\u0440\u043e\u043d\u0435\u043d\u0438\u044f')])),
                ('name', models.CharField(max_length=255, verbose_name='\u041f\u0440\u0438\u0447\u0438\u043d\u0430')),
                ('text', models.TextField(default='', verbose_name='\u0422\u0435\u043a\u0441\u0442 \u043f\u0440\u0438\u0447\u0438\u043d\u044b', editable=False)),
            ],
            options={
