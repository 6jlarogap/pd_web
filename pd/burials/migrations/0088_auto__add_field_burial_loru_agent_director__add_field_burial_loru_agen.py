...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Burial.loru_agent_director'
        db.add_column('burials_burial', 'loru_agent_director',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Burial.loru_agent'
        db.add_column('burials_burial', 'loru_agent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='agent_burials', null=True, on_delete=models.PROTECT, to=orm['users.Profile']),
                      keep_default=False)

        # Adding field 'Burial.loru_dover'
        db.add_column('burials_burial', 'loru_dover',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='dover_burials', null=True, on_delete=models.PROTECT, to=orm['users.Dover']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Burial.loru_agent_director'
        db.delete_column('burials_burial', 'loru_agent_director')

        # Deleting field 'Burial.loru_agent'
        db.delete_column('burials_burial', 'loru_agent_id')

        # Deleting field 'Burial.loru_dover'
        db.delete_column('burials_burial', 'loru_dover_id')
