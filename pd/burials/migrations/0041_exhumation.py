...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExhumationRequest'
        db.create_table('burials_exhumationrequest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('burial', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['burials.Burial'], unique=True)),
            ...
            ('applicant_person', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='applied_exhumations', null=True, to=orm['persons.AlivePerson'])),
            ('applicant_org', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='loru_exhumations', null=True, on_delete=models.PROTECT, to=orm['users.Org'])),
        ))
        db.send_create_signal('burials', ['ExhumationRequest'])


    def backwards(self, orm):
        # Deleting model 'ExhumationRequest'
        db.delete_table('burials_exhumationrequest')
    ...
    models = {
        ...
        'burials.exhumationrequest': {
            ...
            'applicant_org': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'loru_exhumations'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': "orm['users.Org']"}),
            'applicant_person': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'applied_exhumations'", 'null': 'True', 'to': "orm['persons.AlivePerson']"}),
