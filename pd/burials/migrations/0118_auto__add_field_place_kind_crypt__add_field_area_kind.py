...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.kind_crypt'
        db.add_column('burials_place', 'kind_crypt',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Area.kind'
        db.add_column('burials_area', 'kind',
                      self.gf('django.db.models.fields.CharField')(default='g', max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.kind_crypt'
        db.delete_column('burials_place', 'kind_crypt')

        # Deleting field 'Area.kind'
        db.delete_column('burials_area', 'kind')
