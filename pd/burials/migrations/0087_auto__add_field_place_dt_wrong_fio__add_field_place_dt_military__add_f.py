...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.dt_wrong_fio'
        db.add_column('burials_place', 'dt_wrong_fio',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Place.dt_military'
        db.add_column('burials_place', 'dt_military',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Place.dt_size_violated'
        db.add_column('burials_place', 'dt_size_violated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Place.dt_unowned'
        db.add_column('burials_place', 'dt_unowned',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Place.dt_unindentified'
        db.add_column('burials_place', 'dt_unindentified',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.dt_wrong_fio'
        db.delete_column('burials_place', 'dt_wrong_fio')

        # Deleting field 'Place.dt_military'
        db.delete_column('burials_place', 'dt_military')

        # Deleting field 'Place.dt_size_violated'
        db.delete_column('burials_place', 'dt_size_violated')

        # Deleting field 'Place.dt_unowned'
        db.delete_column('burials_place', 'dt_unowned')

        # Deleting field 'Place.dt_unindentified'
        db.delete_column('burials_place', 'dt_unindentified')
