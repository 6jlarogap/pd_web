...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('burials_burial', (
            ...
            ('fact_date', self.gf('django.db.models.fields.DateField')()),
            ('fact_time', self.gf('django.db.models.fields.TimeField')()),
            ('deadman', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.DeadPerson'])),
        ))
        db.send_create_signal('burials', ['Burial'])

        # Adding field 'BurialRequest.burial'
        db.add_column('burials_burialrequest', 'burial',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['burials.Burial'], unique=True, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'BurialRequest.burial'
        db.delete_column('burials_burialrequest', 'burial_id')
    ...
    models = {
        ...
        'burials.burial': {
            ...
            'fact_time': ('django.db.models.fields.TimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
