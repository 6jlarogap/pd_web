...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cemetery.time_slots'
        db.add_column('burials_cemetery', 'time_slots',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Cemetery.time_slots'
        db.delete_column('burials_cemetery', 'time_slots')
