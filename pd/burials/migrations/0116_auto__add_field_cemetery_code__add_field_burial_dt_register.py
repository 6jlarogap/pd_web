...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cemetery.code'
        db.add_column('burials_cemetery', 'code',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=50),
                      keep_default=False)

        # Adding field 'Burial.dt_register'
        db.add_column('burials_burial', 'dt_register',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cemetery.code'
        db.delete_column('burials_cemetery', 'code')

        # Deleting field 'Burial.dt_register'
        db.delete_column('burials_burial', 'dt_register')
