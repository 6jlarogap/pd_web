...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Cemetery.time_period'
        db.delete_column('burials_cemetery', 'time_period')

        # Adding field 'Cemetery.period'
        db.add_column('burials_cemetery', 'period',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=15),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Cemetery.time_period'
        db.add_column('burials_cemetery', 'time_period',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=15),
                      keep_default=False)

        # Deleting field 'Cemetery.period'
        db.delete_column('burials_cemetery', 'period')
