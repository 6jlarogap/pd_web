...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('burials_place', 'area_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.Area'], null=True, on_delete=models.PROTECT))
        # Deleting field 'Grave.name'
        db.delete_column('burials_grave', 'name')

        # Adding field 'Grave.grave_number'
        db.add_column('burials_grave', 'grave_number',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Grave.lat'
        db.add_column('burials_grave', 'lat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Grave.lng'
        db.add_column('burials_grave', 'lng',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Burial.deadman'
        db.alter_column('burials_burial', 'deadman_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.DeadPerson'], null=True, on_delete=models.PROTECT))

        # Changing field 'Burial.area'
        db.alter_column('burials_burial', 'area_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.Area'], null=True, on_delete=models.PROTECT))

        # Changing field 'Burial.responsible'
        db.alter_column('burials_burial', 'responsible_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['persons.AlivePerson']))

        # Changing field 'Burial.applicant'
        db.alter_column('burials_burial', 'applicant_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['persons.AlivePerson']))

        # Changing field 'ExhumationRequest.applicant'
        db.alter_column('burials_exhumationrequest', 'applicant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.AlivePerson'], null=True, on_delete=models.PROTECT))

        # Changing field 'ExhumationRequest.applicant_organization'
        db.alter_column('burials_exhumationrequest', 'applicant_organization_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Org'], null=True, on_delete=models.PROTECT))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Place.area'
        db.alter_column('burials_place', 'area_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.Area'], null=True))
        # Adding field 'Grave.name'
        db.add_column('burials_grave', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)

        # Deleting field 'Grave.grave_number'
        db.delete_column('burials_grave', 'grave_number')

        # Deleting field 'Grave.lat'
        db.delete_column('burials_grave', 'lat')

        # Deleting field 'Grave.lng'
        db.delete_column('burials_grave', 'lng')


        # Changing field 'Burial.deadman'
        db.alter_column('burials_burial', 'deadman_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.DeadPerson'], null=True))

        # Changing field 'Burial.area'
        db.alter_column('burials_burial', 'area_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.Area'], null=True))

        # Changing field 'Burial.responsible'
        db.alter_column('burials_burial', 'responsible_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['persons.AlivePerson']))

        # Changing field 'Burial.applicant'
        db.alter_column('burials_burial', 'applicant_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['persons.AlivePerson']))

        # Changing field 'ExhumationRequest.applicant'
        db.alter_column('burials_exhumationrequest', 'applicant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.AlivePerson'], null=True))

        # Changing field 'ExhumationRequest.applicant_organization'
        db.alter_column('burials_exhumationrequest', 'applicant_organization_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Org'], null=True))
