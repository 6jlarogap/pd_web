...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExhumationRequest.place'
        db.alter_column('burials_exhumationrequest', 'place_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.Place'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ExhumationRequest.place'
        raise RuntimeError("Cannot reverse this migration. 'ExhumationRequest.place' and its values cannot be restored.")
