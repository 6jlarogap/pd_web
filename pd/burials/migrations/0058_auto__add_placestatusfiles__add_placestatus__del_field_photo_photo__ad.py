...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PlaceStatusFiles'
        db.create_table('burials_placestatusfiles', (
            ...
            ('placestatus', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.PlaceStatus'])),
        ))
        db.send_create_signal('burials', ['PlaceStatusFiles'])

        # Adding model 'PlaceStatus'
        db.create_table('burials_placestatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('place', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.Place'])),
            ('status', self.gf('django.db.models.fields.CharField')(default='actual', max_length=40)),
            ('comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], on_delete=models.PROTECT)),
            ('date_of_creation', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('burials', ['PlaceStatus'])

        # Deleting field 'Photo.photo'
        db.delete_column('burials_photo', 'photo')

        # Adding field 'Photo.bfile'
        db.add_column('burials_photo', 'bfile',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Photo.original_name'
        db.add_column('burials_photo', 'original_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Photo.creator'
        db.add_column('burials_photo', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT),
                      keep_default=False)

        # Adding field 'Photo.date_of_creation'
        db.add_column('burials_photo', 'date_of_creation',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 7, 19, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'Photo.comment'
        db.alter_column('burials_photo', 'comment', self.gf('django.db.models.fields.CharField')(default='', max_length=96))

    def backwards(self, orm):
        # Deleting model 'PlaceStatusFiles'
        db.delete_table('burials_placestatusfiles')

        # Deleting model 'PlaceStatus'
        db.delete_table('burials_placestatus')

        # Adding field 'Photo.photo'
        db.add_column('burials_photo', 'photo',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100),
                      keep_default=False)

        # Deleting field 'Photo.bfile'
        db.delete_column('burials_photo', 'bfile')

        # Deleting field 'Photo.original_name'
        db.delete_column('burials_photo', 'original_name')

        # Deleting field 'Photo.creator'
        db.delete_column('burials_photo', 'creator_id')

        # Deleting field 'Photo.date_of_creation'
        db.delete_column('burials_photo', 'date_of_creation')


        # Changing field 'Photo.comment'
        db.alter_column('burials_photo', 'comment', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'burials.gravephoto': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['burials.Photo']"})
        },
        'burials.photo': {
