...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExhumationRequest.fact_date'
        db.add_column('burials_exhumationrequest', 'fact_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


        # Changing field 'ExhumationRequest.plan_date'
        db.alter_column('burials_exhumationrequest', 'plan_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'ExhumationRequest.plan_time'
        db.alter_column('burials_exhumationrequest', 'plan_time', self.gf('django.db.models.fields.TimeField')(null=True))

    def backwards(self, orm):
        # Deleting field 'ExhumationRequest.fact_date'
        db.delete_column('burials_exhumationrequest', 'fact_date')


        # User chose to not deal with backwards NULL issues for 'ExhumationRequest.plan_date'
        raise RuntimeError("Cannot reverse this migration. 'ExhumationRequest.plan_date' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ExhumationRequest.plan_time'
        raise RuntimeError("Cannot reverse this migration. 'ExhumationRequest.plan_time' and its values cannot be restored.")
