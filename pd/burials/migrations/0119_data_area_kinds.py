...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for horz_columbarium in horz_columbariums:
            n += Area.objects.filter(cemetery__ugh__name=u'Спецкомбинат КБО', **horz_columbarium).update(kind='h')
        print '%s horizontal columbarium areas kind updated' % n
    ...
    models = {
        ...
        'burials.area': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kind': ('django.db.models.fields.CharField', [], {'default': "'g'", 'max_length': '8'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        'burials.place': {
            ...
            'kind_crypt': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'lat': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'lng': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
