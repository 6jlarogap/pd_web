...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Place.responsible'
        db.alter_column('burials_place', 'responsible_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.AlivePerson'], null=True, on_delete=models.PROTECT))

        # Changing field 'Place.cemetery'
        db.alter_column('burials_place', 'cemetery_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.Cemetery'], on_delete=models.PROTECT))

        # Changing field 'Area.cemetery'
        db.alter_column('burials_area', 'cemetery_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.Cemetery'], on_delete=models.PROTECT))

        # Changing field 'Area.purpose'
        db.alter_column('burials_area', 'purpose_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.AreaPurpose'], null=True, on_delete=models.PROTECT))
        # Deleting field 'Burial.created'
        db.delete_column('burials_burial', 'created')

        # Deleting field 'Burial.creator'
        db.delete_column('burials_burial', 'creator_id')

        # Adding field 'Burial.ugh'
        db.add_column('burials_burial', 'ugh',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='ugh_created', null=True, on_delete=models.PROTECT, to=orm['users.Org']),
                      keep_default=False)


        # Changing field 'Burial.loru'
        db.alter_column('burials_burial', 'loru_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['users.Org']))

        # Changing field 'Burial.changed_by'
        db.alter_column('burials_burial', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['auth.User']))

        # Changing field 'Burial.agent'
        db.alter_column('burials_burial', 'agent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'], null=True, on_delete=models.PROTECT))

        # Changing field 'Burial.place'
        db.alter_column('burials_burial', 'place_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.Place'], null=True, on_delete=models.PROTECT))

        # Changing field 'Burial.cemetery'
        db.alter_column('burials_burial', 'cemetery_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.Cemetery'], null=True, on_delete=models.PROTECT))

        # Changing field 'Cemetery.ugh'
        db.alter_column('burials_cemetery', 'ugh_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Org'], null=True, on_delete=models.PROTECT))

        # Changing field 'Cemetery.creator'
        db.alter_column('burials_cemetery', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'Place.responsible'
        db.alter_column('burials_place', 'responsible_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.AlivePerson'], null=True))

        # Changing field 'Place.cemetery'
        db.alter_column('burials_place', 'cemetery_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.Cemetery']))

        # Changing field 'Area.cemetery'
        db.alter_column('burials_area', 'cemetery_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.Cemetery']))

        # Changing field 'Area.purpose'
        db.alter_column('burials_area', 'purpose_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.AreaPurpose'], null=True))

        # User chose to not deal with backwards NULL issues for 'Burial.created'
        raise RuntimeError("Cannot reverse this migration. 'Burial.created' and its values cannot be restored.")
        # Adding field 'Burial.creator'
        db.add_column('burials_burial', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Deleting field 'Burial.ugh'
        db.delete_column('burials_burial', 'ugh_id')


        # Changing field 'Burial.loru'
        db.alter_column('burials_burial', 'loru_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Org'], null=True))

        # Changing field 'Burial.changed_by'
        db.alter_column('burials_burial', 'changed_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Burial.agent'
        db.alter_column('burials_burial', 'agent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'], null=True))

        # Changing field 'Burial.place'
        db.alter_column('burials_burial', 'place_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.Place'], null=True))

        # Changing field 'Burial.cemetery'
        db.alter_column('burials_burial', 'cemetery_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.Cemetery'], null=True))

        # Changing field 'Cemetery.ugh'
        db.alter_column('burials_cemetery', 'ugh_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Org'], null=True))
    ...
    models = {
        ...
        'burials.burial': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'loru': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'loru_created'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': "orm['users.Org']"}),
