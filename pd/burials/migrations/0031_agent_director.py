...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Burial.agent_director'
        db.add_column('burials_burial', 'agent_director',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Burial.agent_director'
        db.delete_column('burials_burial', 'agent_director')
