...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # - Заполнить поле dt_register: время последней модификации закрытого захоронения,
        #   когда вносились изменения в значимые для реестра поля: фио, идент номер,
        #   сектор, ряд, место, могила.
        #
        # - Для минских кладбищ заполнить коды
        
        if not settings.DEADMAN_IDENT_NUMBER_ALLOW:
            # Реестр немыслим без ид для усопшего
            return None
        ...
        q = Q(
            ...
            fact_date__gte=settings.DEADMAN_REGISTER_START_DATE,
        )
        q &= ~Q(place_number=u'-')

        print 'Filling Burial.dt_register'
        count = 0
        for b in Burial.objects.filter(q).distinct():
            Burial.objects.filter(pk=b.pk).update(dt_register=b.dt_modified)
            count += 1
            if count % 1000 == 0:
                print '%s burials filled' % count
        if count % 1000 != 0:
            print '%s burials filled' % count

        print "Filling Minsk cemeteries' codes"
        UGH_MINSK_PK = 2
        CEMETERIES_MINSK = (
            (u'Брилевское',                         u'700000101'),
            (u'Военное',                            u'700000102'),
            (u'Восточное',                          u'700000103'),
            (u'Дворище',                            u'700000104'),
            (u'Западное',                           u'700000124'),
            (u'Кальварийское',                      u'700000105'),
            (u'Козыревское',                        u'700000106'),
            (u'Колодищи',                           u'700000117'),
            (u'Колумбарий кладбища Восточное',      u'700000103'),
            (u'Колумбарий кладбища Западное',       u'700000124'),
            (u'Колумбарий кладбища Кальварийское',  u'700000105'),
            (u'Колумбарий кладбища Петровщина',     u'700000112'),
            (u'Колумбарий кладбища Северное-1',     u'700000120'),
            (u'Колумбарий кладбища Северное-2',     u'700000122'),
            (u'Колумбарий кладбища Северное-3',     u'700000123'),
            (u'Колумбарий, кладбище Чижовское',     u'700000116'),
            (u'Колумбарий, Крематорий',             u'700000121'),
            (u'Красная Слобода',                    u'700000107'),
            (u'Крупцы',                             u'700000108'),
            (u'Лошица',                             u'700000109'),
            (u'Малый Тростенец',                    u'700000110'),
            (u'Масюковщина',                        u'700000111'),
            (u'Михановичи',                         u'700000118'),
            (u'Петровщина',                         u'700000112'),
            (u'Северное-1',                         u'700000120'),
            (u'Северное-2',                         u'700000122'),
            (u'Северное-3',                         u'700000123'),
            (u'Сухаревское',                        u'700000113'),
            (u'Уручье',                             u'700000114'),
            (u'Цна',                                u'700000115'),
            (u'Черниговское',                       u'700000116'),
            (u'Чижовское',                          u'700000119'),
        )
        Cemetery = orm['burials.Cemetery']
        for cn in CEMETERIES_MINSK:
            try:
                c = Cemetery.objects.get(ugh__pk=UGH_MINSK_PK, name=cn[0])
                Cemetery.objects.filter(pk=c.pk).update(code=cn[1])
    ...
    models = {
        ...
        'burials.burial': {
            ...
            'dt_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'dt_register': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
        ...
        'persons.baseperson': {
            ...
            'address': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['geo.Location']", 'null': 'True', 'on_delete': 'models.PROTECT'}),
