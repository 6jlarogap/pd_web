...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AreaPhoto.bfile'
        db.alter_column('burials_areaphoto', 'bfile', self.gf('django.db.models.fields.files.FileField')(max_length=255))

        # Changing field 'PlaceStatusFiles.bfile'
        db.alter_column('burials_placestatusfiles', 'bfile', self.gf('django.db.models.fields.files.FileField')(max_length=255))

        # Changing field 'BurialFiles.bfile'
        db.alter_column('burials_burialfiles', 'bfile', self.gf('django.db.models.fields.files.FileField')(max_length=255))

        # Changing field 'PlacePhoto.bfile'
        db.alter_column('burials_placephoto', 'bfile', self.gf('django.db.models.fields.files.FileField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'AreaPhoto.bfile'
        db.alter_column('burials_areaphoto', 'bfile', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'PlaceStatusFiles.bfile'
        db.alter_column('burials_placestatusfiles', 'bfile', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'BurialFiles.bfile'
        db.alter_column('burials_burialfiles', 'bfile', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'PlacePhoto.bfile'
        db.alter_column('burials_placephoto', 'bfile', self.gf('django.db.models.fields.files.FileField')(max_length=100))
