...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OrderPlace.place_length'
        db.delete_column('burials_orderplace', 'place_length')

        # Deleting field 'OrderPlace.place_width'
        db.delete_column('burials_orderplace', 'place_width')

        # Adding field 'OrderPlace.size'
        db.add_column('burials_orderplace', 'size',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'OrderPlace.place_length'
        db.add_column('burials_orderplace', 'place_length',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2),
                      keep_default=False)

        # Adding field 'OrderPlace.place_width'
        db.add_column('burials_orderplace', 'place_width',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2),
                      keep_default=False)

        # Deleting field 'OrderPlace.size'
        db.delete_column('burials_orderplace', 'size')
