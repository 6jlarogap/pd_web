...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Burial.fact_time'
        db.delete_column('burials_burial', 'fact_time')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Burial.fact_time'
        raise RuntimeError("Cannot reverse this migration. 'Burial.fact_time' and its values cannot be restored.")
