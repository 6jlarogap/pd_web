...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cemetery.archive_burial_fact_date_required'
        db.add_column('burials_cemetery', 'archive_burial_fact_date_required',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Cemetery.archive_burial_account_number_required'
        db.add_column('burials_cemetery', 'archive_burial_account_number_required',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cemetery.archive_burial_fact_date_required'
        db.delete_column('burials_cemetery', 'archive_burial_fact_date_required')

        # Deleting field 'Cemetery.archive_burial_account_number_required'
        db.delete_column('burials_cemetery', 'archive_burial_account_number_required')
