...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('burials_areaphoto', (
            ...
            ('area', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.Area'])),
        ))
        db.send_create_signal('burials', ['AreaPhoto'])

        # Adding field 'Place.lat'
        db.add_column('burials_place', 'lat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Place.lng'
        db.add_column('burials_place', 'lng',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Place.available_count'
        db.add_column('burials_place', 'available_count',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('burials_areaphoto')

        # Deleting field 'Place.lat'
        db.delete_column('burials_place', 'lat')

        # Deleting field 'Place.lng'
        db.delete_column('burials_place', 'lng')

        # Deleting field 'Place.available_count'
        db.delete_column('burials_place', 'available_count')

        # Deleting field 'GravePhoto.dt_created'
        db.delete_column('burials_gravephoto', 'dt_created')

        # Deleting field 'GravePhoto.dt_modified'
        db.delete_column('burials_gravephoto', 'dt_modified')
