...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Burial.order'
        db.add_column('burials_burial', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Order'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Burial.order'
        db.delete_column('burials_burial', 'order_id')
    ...
    models = {
        ...
        'burials.burial': {
            ...
            'places_type': ('django.db.models.fields.CharField', [], {'default': "'manual'", 'max_length': '255'}),
