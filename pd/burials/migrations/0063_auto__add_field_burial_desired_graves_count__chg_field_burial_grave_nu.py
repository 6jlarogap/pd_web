...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Burial.desired_graves_count'
        db.add_column('burials_burial', 'desired_graves_count',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)


        # Changing field 'Burial.grave_number'
        db.alter_column('burials_burial', 'grave_number', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

    def backwards(self, orm):
        # Deleting field 'Burial.desired_graves_count'
        db.delete_column('burials_burial', 'desired_graves_count')


        # Changing field 'Burial.grave_number'
        db.alter_column('burials_burial', 'grave_number', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=255))
