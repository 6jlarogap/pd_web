...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Burial.ugh_approved'
        db.add_column('burials_burial', 'ugh_approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Burial.loru_processed'
        db.add_column('burials_burial', 'loru_processed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Burial.ugh_finished'
        db.add_column('burials_burial', 'ugh_finished',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Burial.ugh_approved'
        db.delete_column('burials_burial', 'ugh_approved')

        # Deleting field 'Burial.loru_processed'
        db.delete_column('burials_burial', 'loru_processed')

        # Deleting field 'Burial.ugh_finished'
        db.delete_column('burials_burial', 'ugh_finished')
    ...
    models = {
        ...
        'burials.burial': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'loru_processed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'ugh_approved': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'ugh_finished': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'burials.cemetery': {
