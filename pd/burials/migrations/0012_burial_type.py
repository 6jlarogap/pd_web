...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BurialRequest.burial_type'
        db.add_column('burials_burialrequest', 'burial_type',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BurialRequest.burial_type'
        db.delete_column('burials_burialrequest', 'burial_type')
