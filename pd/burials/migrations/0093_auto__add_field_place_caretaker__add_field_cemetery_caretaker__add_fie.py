...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.caretaker'
        db.add_column('burials_place', 'caretaker',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='caretaker_places', null=True, on_delete=models.PROTECT, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Cemetery.caretaker'
        db.add_column('burials_cemetery', 'caretaker',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='caretaker_cemeteries', null=True, on_delete=models.PROTECT, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Area.caretaker'
        db.add_column('burials_area', 'caretaker',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='caretaker_areas', null=True, on_delete=models.PROTECT, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.caretaker'
        db.delete_column('burials_place', 'caretaker_id')

        # Deleting field 'Cemetery.caretaker'
        db.delete_column('burials_cemetery', 'caretaker_id')

        # Deleting field 'Area.caretaker'
        db.delete_column('burials_area', 'caretaker_id')
