...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Burial.places_type'
        db.delete_column('burials_burial', 'places_type')

        # Adding field 'Cemetery.places_algo'
        db.add_column('burials_cemetery', 'places_algo',
                      self.gf('django.db.models.fields.CharField')(default='manual', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Burial.places_type'
        db.add_column('burials_burial', 'places_type',
                      self.gf('django.db.models.fields.CharField')(default='manual', max_length=255),
                      keep_default=False)

        # Deleting field 'Cemetery.places_algo'
        db.delete_column('burials_cemetery', 'places_algo')
