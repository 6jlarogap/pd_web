...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Burial.grave_number'
        db.add_column('burials_burial', 'grave_number',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1, max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Burial.grave_number'
        db.delete_column('burials_burial', 'grave_number')
    ...
    models = {
        ...
        'burials.burial': {
            ...
            'grave_number': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1', 'max_length': '255', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
