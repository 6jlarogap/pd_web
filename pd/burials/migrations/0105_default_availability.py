...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Area.availability'
        Area = orm['burials.Area']
        Area.objects.filter(availability__isnull=True).update(availability='open')
        db.alter_column('burials_area', 'availability', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'Area.availability'
        db.alter_column('burials_area', 'availability', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
