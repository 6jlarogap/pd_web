...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BurialFiles'
        db.create_table('burials_burialfiles', (
        ...
        db.send_create_signal('burials', ['BurialFiles'])


    def backwards(self, orm):
        # Deleting model 'BurialFiles'
        db.delete_table('burials_burialfiles')
