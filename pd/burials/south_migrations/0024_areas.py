...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AreaPurpose'
        db.create_table('burials_areapurpose', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('burials', ['AreaPurpose'])

        # Adding field 'Area.availability'
        db.add_column('burials_area', 'availability',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True),
                      keep_default=False)

        # Adding field 'Area.purpose'
        db.add_column('burials_area', 'purpose',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.AreaPurpose'], null=True),
                      keep_default=False)

        # Adding field 'Area.places_count'
        db.add_column('burials_area', 'places_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'AreaPurpose'
        db.delete_table('burials_areapurpose')

        # Deleting field 'Area.availability'
        db.delete_column('burials_area', 'availability')

        # Deleting field 'Area.purpose'
        db.delete_column('burials_area', 'purpose_id')

        # Deleting field 'Area.places_count'
        db.delete_column('burials_area', 'places_count')
    ...
    models = {
        ...
        'burials.burial': {
            ...
            'deadman': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['persons.DeadPerson']"}),
            'fact_date': ('django.db.models.fields.DateField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'burials.burialrequest': {
            ...
            'burial': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['burials.Burial']", 'unique': 'True', 'null': 'True'}),
            'burial_type': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
