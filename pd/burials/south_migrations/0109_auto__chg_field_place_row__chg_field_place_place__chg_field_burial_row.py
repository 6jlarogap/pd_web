...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        cursor.execute('DROP VIEW burials_burial1;')
        
        # Changing field 'Place.row'
        db.alter_column('burials_place', 'row', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Place.place'
        db.alter_column('burials_place', 'place', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Burial.row'
        db.alter_column('burials_burial', 'row', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Burial.place_number'
        db.alter_column('burials_burial', 'place_number', self.gf('django.db.models.fields.CharField')(max_length=255))

        call_command('create_burial_views', 'yes')

    def backwards(self, orm):

        # Changing field 'Place.row'
        db.alter_column('burials_place', 'row', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Place.place'
        db.alter_column('burials_place', 'place', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Burial.row'
        db.alter_column('burials_burial', 'row', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Burial.place_number'
        db.alter_column('burials_burial', 'place_number', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
