...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.is_invent'
        db.add_column('burials_place', 'is_invent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Place.dt_processed'
        db.add_column('burials_place', 'dt_processed',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Place.user_processed'
        db.add_column('burials_place', 'user_processed',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.PROTECT),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.is_invent'
        db.delete_column('burials_place', 'is_invent')

        # Deleting field 'Place.dt_processed'
        db.delete_column('burials_place', 'dt_processed')

        # Deleting field 'Place.user_processed'
        db.delete_column('burials_place', 'user_processed_id')
