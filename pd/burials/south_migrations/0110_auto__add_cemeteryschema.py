...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CemeterySchema'
        db.create_table('burials_cemeteryschema', (
        ...
        db.send_create_signal('burials', ['CemeterySchema'])


    def backwards(self, orm):
        # Deleting model 'CemeterySchema'
        db.delete_table('burials_cemeteryschema')
