...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cemetery.time_begin'
        db.alter_column('burials_cemetery', 'time_begin', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'Cemetery.time_end'
        db.alter_column('burials_cemetery', 'time_end', self.gf('django.db.models.fields.TimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Cemetery.time_begin'
        db.alter_column('burials_cemetery', 'time_begin', self.gf('django.db.models.fields.TimeField')(default=datetime.time(10, 0)))

        # Changing field 'Cemetery.time_end'
        db.alter_column('burials_cemetery', 'time_end', self.gf('django.db.models.fields.TimeField')(default=datetime.time(17, 0)))
