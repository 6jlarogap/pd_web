...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ("burials", "0052_datamigration_0051"),
    )
    ...
    def backwards(self, orm):
        ...
        db.add_column('burials_burial', 'order',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='burial_order', unique=True, null=True, to=orm['orders.Order']),
                      keep_default=False)
