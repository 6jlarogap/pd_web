...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Place', fields ['place', 'row', 'cemetery', 'area']
        db.create_unique('burials_place', ['place', 'row', 'cemetery_id', 'area_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Place', fields ['place', 'row', 'cemetery', 'area']
        db.delete_unique('burials_place', ['place', 'row', 'cemetery_id', 'area_id'])
