...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PlaceStatus.date_of_creation'
        db.delete_column('burials_placestatus', 'date_of_creation')

        # Deleting field 'Cemetery.created'
        db.delete_column('burials_cemetery', 'created')


    def backwards(self, orm):
        # Adding field 'PlaceStatus.date_of_creation'
        db.add_column('burials_placestatus', 'date_of_creation',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Cemetery.created'
        db.add_column('burials_cemetery', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 13, 0, 0), blank=True),
                      keep_default=False)
