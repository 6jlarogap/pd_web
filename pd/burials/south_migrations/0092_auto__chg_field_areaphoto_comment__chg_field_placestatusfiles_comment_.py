...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AreaPhoto.comment'
        db.alter_column('burials_areaphoto', 'comment', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'PlaceStatusFiles.comment'
        db.alter_column('burials_placestatusfiles', 'comment', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'BurialFiles.comment'
        db.alter_column('burials_burialfiles', 'comment', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'PlacePhoto.comment'
        db.alter_column('burials_placephoto', 'comment', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'AreaPhoto.comment'
        db.alter_column('burials_areaphoto', 'comment', self.gf('django.db.models.fields.CharField')(max_length=96))

        # Changing field 'PlaceStatusFiles.comment'
        db.alter_column('burials_placestatusfiles', 'comment', self.gf('django.db.models.fields.CharField')(max_length=96))

        # Changing field 'BurialFiles.comment'
        db.alter_column('burials_burialfiles', 'comment', self.gf('django.db.models.fields.CharField')(max_length=96))

        # Changing field 'PlacePhoto.comment'
        db.alter_column('burials_placephoto', 'comment', self.gf('django.db.models.fields.CharField')(max_length=96))
