...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Burial.order'
        db.alter_column('burials_burial', 'order_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['orders.Order'], unique=True, null=True))
        # Adding unique constraint on 'Burial', fields ['order']
        db.create_unique('burials_burial', ['order_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Burial', fields ['order']
        db.delete_unique('burials_burial', ['order_id'])


        # Changing field 'Burial.order'
        db.alter_column('burials_burial', 'order_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Order'], null=True))
