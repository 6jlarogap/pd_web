...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrderPlace'
        db.create_table('burials_orderplace', (
            ...
            ('cemetery_text', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('area', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.Area'], null=True)),
            ('row', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('place', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('place_length', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2)),
            ('place_width', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2)),
        ))
        db.send_create_signal('burials', ['OrderPlace'])


    def backwards(self, orm):
        # Deleting model 'OrderPlace'
        db.delete_table('burials_orderplace')
    ...
    models = {
        ...
        'burials.orderplace': {
            ...
            'place_length': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '2'}),
            'place_width': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '2'}),
