...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.geohash'
        db.add_column('burials_place', 'geohash',
                      self.gf('django.db.models.fields.CharField')(max_length=12, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.geohash'
        db.delete_column('burials_place', 'geohash')
