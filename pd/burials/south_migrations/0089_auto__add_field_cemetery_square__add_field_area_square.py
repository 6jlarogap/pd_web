...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cemetery.square'
        db.add_column('burials_cemetery', 'square',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'Area.square'
        db.add_column('burials_area', 'square',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cemetery.square'
        db.delete_column('burials_cemetery', 'square')

        # Deleting field 'Area.square'
        db.delete_column('burials_area', 'square')
