...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Burial.grave'
        db.add_column('burials_burial', 'grave',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.Grave'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Grave'
        db.delete_table('burials_grave')

        # Deleting model 'GravePhoto'
        db.delete_table('burials_gravephoto')

        # Deleting field 'Burial.grave'
        db.delete_column('burials_burial', 'grave_id')
