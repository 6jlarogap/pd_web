...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BurialComment'
        db.create_table('burials_burialcomment', (
        ...
        db.send_create_signal('burials', ['BurialComment'])


    def backwards(self, orm):
        # Deleting model 'BurialComment'
        db.delete_table('burials_burialcomment')
