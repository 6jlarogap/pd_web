...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PlaceSize'
        db.create_table('burials_placesize', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('org', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Org'])),
            ('graves_count', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('place_length', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('place_width', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
        ))
        db.send_create_signal('burials', ['PlaceSize'])

        # Adding unique constraint on 'PlaceSize', fields ['org', 'graves_count']
        db.create_unique('burials_placesize', ['org_id', 'graves_count'])

        # Adding field 'Place.place_length'
        db.add_column('burials_place', 'place_length',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Place.place_width'
        db.add_column('burials_place', 'place_width',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Burial.place_length'
        db.add_column('burials_burial', 'place_length',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Burial.place_width'
        db.add_column('burials_burial', 'place_width',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'PlaceSize', fields ['org', 'graves_count']
        db.delete_unique('burials_placesize', ['org_id', 'graves_count'])

        # Deleting model 'PlaceSize'
        db.delete_table('burials_placesize')

        # Deleting field 'Place.place_length'
        db.delete_column('burials_place', 'place_length')

        # Deleting field 'Place.place_width'
        db.delete_column('burials_place', 'place_width')

        # Deleting field 'Burial.place_length'
        db.delete_column('burials_burial', 'place_length')

        # Deleting field 'Burial.place_width'
        db.delete_column('burials_burial', 'place_width')
