...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AreaPhoto.dt_created'
        db.alter_column('burials_areaphoto', 'dt_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Place.dt_created'
        db.alter_column('burials_place', 'dt_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Grave.dt_created'
        db.alter_column('burials_grave', 'dt_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Area.dt_created'
        db.alter_column('burials_area', 'dt_created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'PlacePhoto.dt_created'
        db.alter_column('burials_placephoto', 'dt_created', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'AreaPhoto.dt_created'
        db.alter_column('burials_areaphoto', 'dt_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Place.dt_created'
        db.alter_column('burials_place', 'dt_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Grave.dt_created'
        db.alter_column('burials_grave', 'dt_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Area.dt_created'
        db.alter_column('burials_area', 'dt_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'PlacePhoto.dt_created'
        db.alter_column('burials_placephoto', 'dt_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        'burials.burialcomment': {
            'Meta': {'ordering': "['-pk']", 'object_name': 'BurialComment'},
        ...
        'burials.place': {
            ...
            'cemetery': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['burials.Cemetery']", 'on_delete': 'models.PROTECT'}),
            'comment_remakephoto': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'dt_created': ('django.db.models.fields.DateTimeField', [], {}),
