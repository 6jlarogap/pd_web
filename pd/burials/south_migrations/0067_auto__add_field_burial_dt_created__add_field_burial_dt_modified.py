...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Burial.dt_created'
        db.add_column('burials_burial', 'dt_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 9, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Burial.dt_modified'
        db.add_column('burials_burial', 'dt_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 9, 9, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Burial.dt_created'
        db.delete_column('burials_burial', 'dt_created')

        # Deleting field 'Burial.dt_modified'
        db.delete_column('burials_burial', 'dt_modified')
