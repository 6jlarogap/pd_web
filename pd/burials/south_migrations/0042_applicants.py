...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExhumationRequest.applicant_org'
        db.delete_column('burials_exhumationrequest', 'applicant_org_id')

        # Deleting field 'ExhumationRequest.applicant_person'
        db.delete_column('burials_exhumationrequest', 'applicant_person_id')

        # Adding field 'ExhumationRequest.applicant'
        db.add_column('burials_exhumationrequest', 'applicant',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.AlivePerson'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExhumationRequest.applicant_organization'
        db.add_column('burials_exhumationrequest', 'applicant_organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Org'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExhumationRequest.agent_director'
        db.add_column('burials_exhumationrequest', 'agent_director',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ExhumationRequest.agent'
        db.add_column('burials_exhumationrequest', 'agent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)

        # Adding field 'ExhumationRequest.dover'
        db.add_column('burials_exhumationrequest', 'dover',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Dover'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ExhumationRequest.applicant_org'
        db.add_column('burials_exhumationrequest', 'applicant_org',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='loru_exhumations', null=True, to=orm['users.Org'], on_delete=models.PROTECT, blank=True),
                      keep_default=False)

        # Adding field 'ExhumationRequest.applicant_person'
        db.add_column('burials_exhumationrequest', 'applicant_person',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='applied_exhumations', null=True, to=orm['persons.AlivePerson'], blank=True),
                      keep_default=False)

        # Deleting field 'ExhumationRequest.applicant'
        db.delete_column('burials_exhumationrequest', 'applicant_id')

        # Deleting field 'ExhumationRequest.applicant_organization'
        db.delete_column('burials_exhumationrequest', 'applicant_organization_id')

        # Deleting field 'ExhumationRequest.agent_director'
        db.delete_column('burials_exhumationrequest', 'agent_director')

        # Deleting field 'ExhumationRequest.agent'
        db.delete_column('burials_exhumationrequest', 'agent_id')

        # Deleting field 'ExhumationRequest.dover'
        db.delete_column('burials_exhumationrequest', 'dover_id')
