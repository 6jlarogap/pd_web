...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Burial.fact_date_no_month'
        db.add_column('burials_burial', u'fact_date_no_month',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Burial.fact_date_no_day'
        db.add_column('burials_burial', u'fact_date_no_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Burial.fact_date'
        db.alter_column('burials_burial', 'fact_date', self.gf('pd.models.UnclearDateModelField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Burial.fact_date_no_month'
        db.delete_column('burials_burial', u'fact_date_no_month')

        # Deleting field 'Burial.fact_date_no_day'
        db.delete_column('burials_burial', u'fact_date_no_day')


        # Changing field 'Burial.fact_date'
        db.alter_column('burials_burial', 'fact_date', self.gf('django.db.models.fields.DateField')(null=True))
