...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Burial.applicant'
        db.add_column('burials_burial', 'applicant',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='applied_burials', null=True, to=orm['persons.AlivePerson']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Burial.applicant'
        db.delete_column('burials_burial', 'applicant_id')
