...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('burials_burial', 'loru',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Org'], null=True, on_delete=models.PROTECT),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Burial.loru'
        db.delete_column('burials_burial', 'loru_id')
