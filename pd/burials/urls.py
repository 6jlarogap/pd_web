...
urlpatterns = [
    ...
    re_path(r'^burials/place/(?P<pk>\d+)/add_graves/$', views.add_graves, name='add_graves'),
    ...
    re_path(r'^burials/(?P<pk>\d+)/$', views.view_burial, name='view_burial'),
    re_path(r'^burials/(?P<pk>\d+)/edit/$', views.edit_burial, name='edit_burial'),
    re_path(r'^burials/(?P<pk>\d+)/notification/$', views.make_notification, name='make_notification'),
    re_path(r'^burials/(?P<pk>\d+)/spravka/$', views.make_spravka, name='make_spravka'),
    re_path(r'^burials/(?P<pk>\d+)/comment/$', views.burial_comment, name='burial_comment'),
    re_path(r'^burials/(?P<pk>\d+)/comments/edit/$', views.burials_comments_edit, name='burials_comments_edit'),
    re_path(r'^burials/(?P<pk>\d+)/exhumate/$', views.burial_exhumate, name='burial_exhumate'),
    re_path(r'^burials/(?P<pk>\d+)/exhumate/cancel/$', views.burial_cancel_exhumation, name='burial_cancel_exhumation'),
    re_path(r'^burials/(?P<pk>\d+)/exhumate/report/$', views.make_exhumate_report, name='make_exhumate_report'),
    re_path(r'^burials/(?P<pk>\d+)/exhumate/notification/$', views.make_exhumate_notification, name='make_exhumate_notification'),
    ...
    re_path(r'^burialfiles/(?P<pk>\d+)/delete/$', views.delete_burialfile, name='delete_burialfile'),
    re_path(r'^burialfiles/(?P<pk>\d+)/editcomment/$', views.edit_burialfile_comment, name='edit_burialfile_comment'),

    re_path(r'^places/(?P<pk>\d+)/certificate$', views.place_certificate, name='place_certificate'),
    ...
    re_path(r'^api/oms/photo-places/(?P<pk>\d+)/?$', views.api_oms_photo_places_change, name='api_oms_photo_places_change'),
    re_path(r'^api/oms/photo-places/place/(?P<pk>\d+)/?$', views.api_oms_photo_places_detail, name='api_oms_photo_places_detail'),
    ...
    re_path(r'^api/oms/cemeteries/(?P<pk>\d+)/areas/?$', views.api_oms_cemeteries_areas, name='api_oms_cemeteries_areas'),
    re_path(r'^api/oms/cemeteries/(?P<pk>\d+)/deleted_burials/?$',
    ...
    re_path(r'^api/loru/cemeteries/(?P<pk>\d+)/areas/?$', views.api_loru_cemeteries_areas, name='api_loru_cemeteries_areas'),
    re_path(r'^api/oms/cemeteries/(?P<cemetery_pk>\d+)/areas/(?P<area_pk>\d+)/places/?$',
        views.api_oms_areas_places, name='api_oms_areas_places'),

    re_path(r'^api/oms/area/(?P<pk>\d+)/msaccess/sync/?$', views.api_oms_area_msaccess_sync,
        name='api_oms_area_msaccess_sync'),

    re_path(r'^api/oms/places/bounds/?$', views.api_oms_places_bounds, name='api_oms_places_bounds'),
    re_path(r'^api/oms/(?P<ugh_id>\d+)/places/clusters/?$', views.api_oms_places_clusters, name='api_oms_places_clusters'),
    ...
    re_path(r'^api/clients/(?P<token>[0-9a-f]+)/burials-places/(?P<pk>\d+)/?$',
        views.api_client_site_places_id, name='api_client_site_places_id'),

    re_path(r'^api/place/(?P<pk>\d+)/photo-upload/?$', views.api_place_photo_upload, name='api_place_photo_upload'),
