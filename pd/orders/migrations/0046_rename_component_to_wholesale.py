...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column(u'orders_product', 'is_component', 'is_wholesale')
        
        ## Adding field 'Product.is_wholesale'
        #db.add_column('orders_product', 'is_wholesale',
    ...
    def backwards(self, orm):
        ...
        db.rename_column(u'orders_product', 'is_wholesale', 'is_component')

        ## Deleting field 'Product.is_wholesale'
        #db.delete_column('orders_product', 'is_wholesale')
