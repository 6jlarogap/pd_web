...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.drop_column('orders_order', 'person')
        db.add_column('orders_order', 'person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.AlivePerson'], null=True))

        db.drop_column('orders_order', 'org')
        db.add_column('orders_order', 'org', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['users.Org']))


    def backwards(self, orm):
        # Renaming column for 'Order.person' to match new field type.
        db.rename_column('orders_order', 'person_id', 'person')

        # Renaming column for 'Order.org' to match new field type.
        db.rename_column('orders_order', 'org_id', 'org')
