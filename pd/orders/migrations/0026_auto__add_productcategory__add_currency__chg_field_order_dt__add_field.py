...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('orders_productcategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('icon', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('orders', ['ProductCategory'])

        # Adding model 'Currency'
        db.create_table('orders_currency', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('icon', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('orders', ['Currency'])


        # Changing field 'Order.dt'
        db.alter_column('orders_order', 'dt', self.gf('django.db.models.fields.DateField')())
        # Adding field 'Product.description'
        db.add_column('orders_product', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Product.photo'
        db.add_column('orders_product', 'photo',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.sku'
        db.add_column('orders_product', 'sku',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('orders_productcategory')

        # Deleting model 'Currency'
        db.delete_table('orders_currency')


        # Changing field 'Order.dt'
        db.alter_column('orders_order', 'dt', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
        # Deleting field 'Product.description'
        db.delete_column('orders_product', 'description')

        # Deleting field 'Product.photo'
        db.delete_column('orders_product', 'photo')

        # Deleting field 'Product.sku'
        db.delete_column('orders_product', 'sku')
