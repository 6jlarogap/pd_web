...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ResultFile.comment'
        db.alter_column('orders_resultfile', 'comment', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'ResultFile.comment'
        db.alter_column('orders_resultfile', 'comment', self.gf('django.db.models.fields.CharField')(max_length=96))
