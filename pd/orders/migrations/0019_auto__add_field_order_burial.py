...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.burial'
        db.add_column('orders_order', 'burial',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='burial_target', null=True, to=orm['burials.Burial']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.burial'
        db.delete_column('orders_order', 'burial_id')
    ...
    models = {
        ...
        'burials.burial': {
            ...
            'order': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'burial_order'", 'unique': 'True', 'null': 'True', 'to': "orm['orders.Order']"}),
        ...
        'orders.order': {
            ...
            'burial': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'burial_target'", 'null': 'True', 'to': "orm['burials.Burial']"}),
