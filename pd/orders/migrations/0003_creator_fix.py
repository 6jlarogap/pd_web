...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('orders_product', 'owner_id')

        # Adding field 'Product.creator'
        db.add_column('orders_product', 'creator',
    ...
    def backwards(self, orm):
        ...
        db.add_column('orders_product', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Product.creator'
        db.delete_column('orders_product', 'creator_id')
    ...
    models = {
        ...
        'orders.order': {
            ...
            'client_org': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['orgs.Organization']"}),
            'client_person': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['persons.Person']"}),
