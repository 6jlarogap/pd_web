...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('orders', ['Measure'])
        ...
        db.create_table('orders_resultfile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bfile', self.gf('django.db.models.fields.files.FileField')(max_length=255, blank=True)),
        ...
        db.send_create_signal('orders', ['ResultFile'])

        # Adding model 'ServiceItem'
        db.create_table('orders_serviceitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Order'])),
        ...
        db.send_create_signal('orders', ['ServiceItem'])
        ...
        db.create_table('orders_service', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.TextField')(default='')),
        ))
        db.send_create_signal('orders', ['Service'])

        # Adding field 'Order.customplace'
        db.add_column('orders_order', 'customplace',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.CustomPlace'], null=True),
                      keep_default=False)

        # Adding field 'Order.status'
        db.add_column('orders_order', 'status',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('orders_serviceitem')

        # Deleting model 'OrderComment'
        db.delete_table('orders_ordercomment')

        # Deleting model 'Service'
        db.delete_table('orders_service')

        # Deleting field 'Order.customplace'
        db.delete_column('orders_order', 'customplace_id')
