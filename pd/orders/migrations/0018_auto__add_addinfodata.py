...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AddInfoData'
        db.create_table('orders_addinfodata', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['orders.Order'], unique=True)),
            ('add_info', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('orders', ['AddInfoData'])


    def backwards(self, orm):
        # Deleting model 'AddInfoData'
        db.delete_table('orders_addinfodata')
