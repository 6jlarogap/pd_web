...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IorderItem.productgroup_description'
        db.add_column('orders_iorderitem', 'productgroup_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ProductGroup.description'
        db.add_column('orders_productgroup', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IorderItem.productgroup_description'
        db.delete_column('orders_iorderitem', 'productgroup_description')

        # Deleting field 'ProductGroup.description'
        db.delete_column('orders_productgroup', 'description')
