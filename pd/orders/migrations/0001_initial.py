    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(default=b'burial', verbose_name='\u0422\u0438\u043f \u0417\u0430\u043a\u0430\u0437', max_length=255, editable=False, choices=[(b'burial', '\u0417\u0430\u043a\u0430\u0437 \u043d\u0430 \u0437\u0430\u0445\u043e\u0440\u043e\u043d\u0435\u043d\u0438\u0435'), (b'trade', '\u041e\u043f\u0442\u043e\u0432\u044b\u0439 \u0437\u0430\u043a\u0430\u0437'), (b'customer', '\u0417\u0430\u043a\u0430\u0437 \u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u044f')])),
                ...
                ('payment', models.CharField(default=b'cash', max_length=255, verbose_name='\u0422\u0438\u043f \u043f\u043b\u0430\u0442\u0435\u0436\u0430', choices=[(b'cash', '\u041d\u0430\u043b\u0438\u0447\u043d\u044b\u0439'), (b'wire', '\u0411\u0435\u0437\u043d\u0430\u043b\u0438\u0447\u043d\u044b\u0439')])),
                ...
                ('status', models.CharField(default=b'posted', verbose_name='\u0421\u0442\u0430\u0442\u0443\u0441', max_length=255, editable=False, choices=[(b'posted', '\u0420\u0430\u0437\u043c\u0435\u0449\u0435\u043d'), (b'accepted', '\u041f\u0440\u0438\u043d\u044f\u0442'), (b'advanced', '\u0412\u044b\u043f\u043b\u0430\u0447\u0435\u043d \u0430\u0432\u0430\u043d\u0441'), (b'paid', '\u041e\u043f\u043b\u0430\u0447\u0435\u043d'), (b'done', '\u0412\u044b\u043f\u043e\u043b\u043d\u0435\u043d')])),
                ('applicant_approved', models.NullBooleanField(verbose_name='\u041e\u0434\u043e\u0431\u0440\u0435\u043d\u043e \u0437\u0430\u043a\u0430\u0437\u0447\u0438\u043a\u043e\u043c', editable=False)),
                ('title', models.CharField(default=b'', verbose_name='\u041d\u0430\u0438\u043c\u0435\u043d\u043e\u0432\u0430\u043d\u0438\u0435 \u043f\u043e\u043a\u0443\u043f\u0430\u0442\u0435\u043b\u044f', max_length=255, editable=False)),
                ...
                ('initial_place', models.CharField(default=b'', verbose_name='\u041c\u0435\u0441\u0442\u043e \u043f\u043e\u0434\u0430\u0447\u0438 \u043a\u0430\u0442\u0430\u0444\u0430\u043b\u043a\u0430', max_length=255, editable=False)),
                ('initial_time', models.TimeField(verbose_name='\u0412\u0440\u0435\u043c\u044f \u043f\u043e\u0434\u0430\u0447\u0438 \u043a\u0430\u0442\u0430\u0444\u0430\u043b\u043a\u0430', null=True, editable=False)),
                ('service_place', models.CharField(default=b'', verbose_name='\u041c\u0435\u0441\u0442\u043e \u043e\u0442\u043f\u0435\u0432\u0430\u043d\u0438\u044f', max_length=255, editable=False)),
                ('service_time', models.TimeField(verbose_name='\u0412\u0440\u0435\u043c\u044f \u043e\u0442\u043f\u0435\u0432\u0430\u043d\u0438\u044f', null=True, editable=False)),
                ('repast_place', models.CharField(default=b'', verbose_name='\u041c\u0435\u0441\u0442\u043e \u043e\u0442\u043f\u0435\u0432\u0430\u043d\u0438\u044f', max_length=255, editable=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dt_created', models.DateTimeField(auto_now_add=True, verbose_name='\u0414\u0430\u0442\u0430/\u0432\u0440\u0435\u043c\u044f \u0441\u043e\u0437\u0434\u0430\u043d\u0438\u044f')),
                ('dt_modified', models.DateTimeField(auto_now=True, verbose_name='\u0414\u0430\u0442\u0430/\u0432\u0440\u0435\u043c\u044f \u043c\u043e\u0434\u0438\u0444\u0438\u043a\u0430\u0446\u0438\u0438')),
                ('type', models.CharField(default=b'shared', max_length=255, verbose_name='\u0422\u0438\u043f', choices=[(b'private', '\u041b\u0438\u0447\u043d\u044b\u0439'), (b'shared', '\u0414\u043e\u0441\u0442\u0443\u043f\u043d\u044b\u0439 \u0430\u0432\u0442\u043e\u0440\u0443 \u0438 \u0441\u043e\u0431\u0435\u0441\u0435\u0434\u043d\u0438\u043a\u0443'), (b'public', '\u041e\u0431\u0449\u0435\u0434\u043e\u0441\u0442\u0443\u043f\u043d\u044b\u0439')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount', models.DecimalField(default=b'0.00', verbose_name='\u0421\u043a\u0438\u0434\u043a\u0430', editable=False, max_digits=4, decimal_places=2)),
                ...
                ('productgroup_name', models.CharField(default=b'', verbose_name='\u041d\u0430\u0437\u0432\u0430\u043d\u0438\u0435 \u043f\u043e\u0434\u043a\u0430\u0442\u0435\u0433\u043e\u0440\u0438\u0438', max_length=255, editable=False)),
                ('productgroup_description', models.TextField(default=b'', verbose_name='\u041e\u043f\u0438\u0441\u0430\u043d\u0438\u0435 \u043f\u043e\u0434\u043a\u0430\u0442\u0435\u0433\u043e\u0440\u0438\u0438', editable=False, blank=True)),
                ('comment', models.TextField(default=b'', verbose_name='\u041a\u043e\u043c\u043c\u0435\u043d\u0442\u0430\u0440\u0438\u0439', editable=False, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(max_length=255, null=True, verbose_name='\u041c\u0435\u0442\u043e\u0434 \u043f\u043b\u0430\u0442\u0435\u0436\u0430', choices=[(b'test', '\u0422\u0435\u0441\u0442, \u0431\u0435\u0437 \u0440\u0435\u0430\u043b\u044c\u043d\u043e\u0433\u043e \u043f\u043b\u0430\u0442\u0435\u0436\u0430'), (b'cc', '\u041f\u043b\u0430\u0442\u0435\u0436\u043d\u0430\u044f \u043a\u0430\u0440\u0442\u043e\u0447\u043a\u0430')])),
                ('payment_type', models.CharField(max_length=255, null=True, verbose_name='\u0422\u0438\u043f \u0442\u0440\u0430\u043d\u0437\u0430\u043a\u0446\u0438\u0438', choices=[(b'1', 'Completed (\u0417\u0430\u0432\u0435\u0440\u0448\u0435\u043d\u043d\u0430\u044f)'), (b'2', 'Declined (\u041e\u0442\u043a\u043b\u043e\u043d\u0435\u043d\u043d\u0430\u044f)'), (b'3', 'Pending (\u0412 \u043e\u0431\u0440\u0430\u0431\u043e\u0442\u043a\u0435)'), (b'4', 'Authorized (\u0410\u0432\u0442\u043e\u0440\u0438\u0437\u043e\u0432\u0430\u043d\u043d\u0430\u044f)'), (b'5', 'Refunded (\u0412\u043e\u0437\u0432\u0440\u0430\u0449\u0435\u043d\u043d\u0430\u044f)'), (b'6', 'System (\u0421\u0438\u0441\u0442\u0435\u043c\u043d\u0430\u044f))'), (b'7', 'Voided (\u0421\u0431\u0440\u043e\u0448\u0435\u043d\u043d\u0430\u044f \u043f\u043e\u0441\u043b\u0435 \u0430\u0432\u0442\u043e\u0440\u0438\u0437\u0430\u0446\u0438\u0438)'), (b'8', 'Failed (\u041e\u0448\u0438\u0431\u043a\u0430 \u0432 \u043f\u0440\u043e\u0432\u0435\u0434\u0435\u043d\u0438\u0438 \u0442\u0440\u0430\u043d\u0437\u0430\u043a\u0446\u0438\u0438)')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('price', models.DecimalField(default=b'0.00', verbose_name='\u0426\u0435\u043d\u0430', max_digits=20, decimal_places=2)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ptype', models.CharField(blank=True, max_length=255, null=True, verbose_name='\u0422\u0438\u043f', choices=[(b'catafalque', '\u0410\u0432\u0442\u043e\u043a\u0430\u0442\u0430\u0444\u0430\u043b\u043a'), (b'catafalque_comfort', '\u041a\u0430\u0442\u0430\u0444\u0430\u043b\u043a \u043f\u043e\u0432\u044b\u0448. \u043a\u043e\u043c\u0444\u043e\u0440\u0442\u043d\u043e\u0441\u0442\u0438'), (b'loaders', '\u0413\u0440\u0443\u0437\u0447\u0438\u043a\u0438'), (b'diggers', '\u0420\u044b\u0442\u044c\u0435 \u043c\u043e\u0433\u0438\u043b\u044b'), (b'SIGN', '\u041d\u0430\u043f\u0438\u0441\u0430\u043d\u0438\u0435 \u043d\u0430\u0434\u043c\u043e\u0433\u0438\u043b\u044c\u043d\u043e\u0439 \u0442\u0430\u0431\u043b\u0438\u0447\u043a\u0438'), (b'VIP', '\u0412\u0418\u041f \u0431\u0440\u0438\u0433\u0430\u0434\u0430 \u043f\u043e\u0441\u043b\u0435\u043f\u043e\u0445\u043e\u0440\u043e\u043d\u043d\u043e\u0433\u043e \u043e\u0431\u0441\u043b\u0443\u0436\u0438\u0432\u0430\u043d\u0438\u044f')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(default=b'image', max_length=255, verbose_name='\u0422\u0438\u043f', choices=[(b'image', '\u0418\u0437\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u0435'), (b'video', '\u0412\u0438\u0434\u0435\u043e')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=255, verbose_name='\u0417\u0430\u0433\u043b\u0430\u0432\u0438\u0435')),
                ('description', models.TextField(default=b'', verbose_name='\u041e\u043f\u0438\u0441\u0430\u043d\u0438\u0435')),
            ],
            options={
            },
            bases=(models.Model,),
