...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('orders_orderwebpay', (
            ...
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Order'], db_column='order_pk')),
            ('wsb_order_num', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('transaction_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('batch_timestamp', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('currency_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ...
            ('payment_type', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('order_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('rrn', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('wsb_signature', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
    ...
    models = {
        ...
        'orders.orderwebpay': {
            ...
            'batch_timestamp': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'currency_id': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'dt_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'dt_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['orders.Order']", 'db_column': "'order_pk'"}),
            ...
            'rrn': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'transaction_id': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'wsb_order_num': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'wsb_signature': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'orders.orgservice': {
