...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.registered'
        db.add_column('orders_order', 'registered',
                      self.gf('django.db.models.fields.CharField')(default='no', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.registered'
        db.delete_column('orders_order', 'registered')
    ...
    models = {
        ...
        'orders.order': {
            ...
            'registered': ('django.db.models.fields.CharField', [], {'default': "'no'", 'max_length': '255'}),
