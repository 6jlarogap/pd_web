...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Заполнить таблицу Product категорией (productCategory) по умолчанию:
        # "Прочие товары и услуги", предварительно удалив "Прочие товары",
        # "Прочие услуги"
        #
        call_command('default_category_to_products')
