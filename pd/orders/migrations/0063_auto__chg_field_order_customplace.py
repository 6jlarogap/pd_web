...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.customplace'
        db.alter_column('orders_order', 'customplace_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.CustomPlace'], null=True, on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'Order.customplace'
        db.alter_column('orders_order', 'customplace_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.CustomPlace'], null=True))
