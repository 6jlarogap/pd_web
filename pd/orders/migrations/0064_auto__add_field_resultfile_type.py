...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResultFile.type'
        db.add_column('orders_resultfile', 'type',
                      self.gf('django.db.models.fields.CharField')(default=(('image', u'\u0418\u0437\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u0435'), ('video', u'\u0412\u0438\u0434\u0435\u043e')), max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResultFile.type'
        db.delete_column('orders_resultfile', 'type')
    ...
    models = {
        ...
        'orders.resultfile': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "(('image', u'\\u0418\\u0437\\u043e\\u0431\\u0440\\u0430\\u0436\\u0435\\u043d\\u0438\\u0435'), ('video', u'\\u0412\\u0438\\u0434\\u0435\\u043e'))", 'max_length': '255'})
        },
        'orders.route': {
