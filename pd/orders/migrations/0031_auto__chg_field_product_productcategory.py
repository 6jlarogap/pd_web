...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.productcategory'
        db.alter_column('orders_product', 'productcategory_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.ProductCategory'], null=True, on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'Product.productcategory'
        db.alter_column('orders_product', 'productcategory_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.ProductCategory'], null=True))
    ...
    models = {
        ...
        'orders.product': {
            ...
            'productcategory': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['orders.ProductCategory']", 'null': 'True', 'on_delete': 'models.PROTECT', 'blank': 'True'}),
