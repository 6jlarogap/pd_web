...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.is_component'
        db.add_column('orders_product', 'is_component',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.is_component'
        db.delete_column('orders_product', 'is_component')
