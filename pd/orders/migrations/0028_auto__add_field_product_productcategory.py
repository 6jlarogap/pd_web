...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.productcategory'
        db.add_column('orders_product', 'productcategory',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.ProductCategory'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.productcategory'
        db.delete_column('orders_product', 'productcategory_id')
    ...
    models = {
        ...
        'orders.product': {
            ...
            'productcategory': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['orders.ProductCategory']", 'null': 'True'}),
