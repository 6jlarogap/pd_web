...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('orders_product', 'productcategory_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['orders.ProductCategory'], on_delete=models.PROTECT))
