...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.dt_due'
        db.add_column('orders_order', 'dt_due',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'OrderItem.discount'
        db.add_column('orders_orderitem', 'discount',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=4, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.dt_due'
        db.delete_column('orders_order', 'dt_due')
