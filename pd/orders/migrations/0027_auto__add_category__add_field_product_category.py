...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('orders_category', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('orders', ['Category'])

        # Adding field 'Product.category'
        db.add_column('orders_product', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Category'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Category'
        db.delete_table('orders_category')

        # Deleting field 'Product.category'
        db.delete_column('orders_product', 'category_id')
    ...
    models = {
        ...
        'orders.product': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['orders.Category']", 'null': 'True', 'blank': 'True'}),
