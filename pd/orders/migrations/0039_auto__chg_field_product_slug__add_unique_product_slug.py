...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('orders_product', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=255, unique=True, null=True, populate_from='name', unique_with=()))
        # Adding unique constraint on 'Product', fields ['slug']
        db.create_unique('orders_product', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Product', fields ['slug']
        db.delete_unique('orders_product', ['slug'])


        # Changing field 'Product.slug'
        db.alter_column('orders_product', 'slug', self.gf('autoslug.fields.AutoSlugField')(populate_from='name', unique_with=['name'], max_length=255, null=True))
