...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CatafalqueData.duration_time'
        db.delete_column('orders_catafalquedata', 'duration_time')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CatafalqueData.duration_time'
        raise RuntimeError("Cannot reverse this migration. 'CatafalqueData.duration_time' and its values cannot be restored.")
