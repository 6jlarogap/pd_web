...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.burial_plan_time'
        db.add_column('orders_order', 'burial_plan_time',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)

        # Adding field 'Order.initial_place'
        db.add_column('orders_order', 'initial_place',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Order.initial_time'
        db.add_column('orders_order', 'initial_time',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)

        # Adding field 'Order.service_place'
        db.add_column('orders_order', 'service_place',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Order.service_time'
        db.add_column('orders_order', 'service_time',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)

        # Adding field 'Order.repast_place'
        db.add_column('orders_order', 'repast_place',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Order.repast_time'
        db.add_column('orders_order', 'repast_time',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.burial_plan_time'
        db.delete_column('orders_order', 'burial_plan_time')

        # Deleting field 'Order.initial_place'
        db.delete_column('orders_order', 'initial_place')

        # Deleting field 'Order.initial_time'
        db.delete_column('orders_order', 'initial_time')

        # Deleting field 'Order.service_place'
        db.delete_column('orders_order', 'service_place')

        # Deleting field 'Order.service_time'
        db.delete_column('orders_order', 'service_time')

        # Deleting field 'Order.repast_place'
        db.delete_column('orders_order', 'repast_place')

        # Deleting field 'Order.repast_time'
        db.delete_column('orders_order', 'repast_time')
    ...
    models = {
        ...
        'orders.orderitem': {
            ...
            'discount': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '4', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'orders.orderwebpay': {
            'Meta': {'object_name': 'OrderWebPay'},
            'amount': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'batch_timestamp': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'currency_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'dt_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'dt_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['orders.Order']"}),
            'order_ident': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'payment_method': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'payment_type': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'rrn': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'transaction_id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'wsb_order_num': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
            'wsb_signature': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'})
        },
        'orders.orgservice': {
        ...
        'orders.product': {
            ...
            'dt_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_for_visit': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'orders.productcategory': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'sorting': ('django.db.models.fields.CharField', [], {'default': "u'ZZ'", 'max_length': '2'})
        },
        'orders.productgroup': {
        ...
        'orders.resultfile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_title': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['orders.Order']"}),
        ...
        'orders.route': {
            'Meta': {'unique_together': "(('order', 'index'),)", 'object_name': 'Route'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
