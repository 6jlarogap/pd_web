...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrderWebPay'
        db.create_table('orders_orderwebpay', (
            ...
            ('wsb_order_num', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('transaction_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('batch_timestamp', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('currency_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('amount', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('payment_method', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('payment_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('order_ident', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('rrn', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('wsb_signature', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
        ))
        db.send_create_signal('orders', ['OrderWebPay'])


    def backwards(self, orm):
        # Deleting model 'OrderWebPay'
        db.delete_table('orders_orderwebpay')
