...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('orders_productstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Product'], on_delete=models.PROTECT)),
        ...
        db.send_create_signal('orders', ['ProductStatus'])

        # Adding unique constraint on 'ProductStatus', fields ['product', 'ugh']
        db.create_unique('orders_productstatus', ['product_id', 'ugh_id'])

        # Adding model 'ProductHistory'
        db.create_table('orders_producthistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Product'], on_delete=models.PROTECT)),
            ('ugh', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Org'])),
            ...
            ('publish_cost', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2)),
            ('currency', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['billing.Currency'])),
        ))
        db.send_create_signal('orders', ['ProductHistory'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProductStatus', fields ['product', 'ugh']
        db.delete_unique('orders_productstatus', ['product_id', 'ugh_id'])

        # Deleting model 'ProductStatus'
        db.delete_table('orders_productstatus')

        # Deleting model 'ProductHistory'
        db.delete_table('orders_producthistory')
    ...
    models = {
        ...
        'orders.producthistory': {
            'Meta': {'object_name': 'ProductHistory'},
            'currency': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['billing.Currency']"}),
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['orders.Product']", 'on_delete': 'models.PROTECT'}),
            'publish_cost': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'}),
            'ugh': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.Org']"})
        },
        'orders.productstatus': {
            'Meta': {'unique_together': "(('product', 'ugh'),)", 'object_name': 'ProductStatus'},
        ...
        'users.org': {
            ...
            'publish_cost': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '20', 'decimal_places': '2'}),
