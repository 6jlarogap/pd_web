...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.dt_created'
        db.add_column('orders_product', 'dt_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 8, 5, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Product.dt_modified'
        db.add_column('orders_product', 'dt_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 8, 5, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.dt_created'
        db.delete_column('orders_product', 'dt_created')

        # Deleting field 'Product.dt_modified'
        db.delete_column('orders_product', 'dt_modified')
