...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.annulated'
        db.add_column('orders_order', 'annulated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.annulated'
        db.delete_column('orders_order', 'annulated')
    ...
    models = {
        ...
        'users.profile': {
            ...
            'numbers_algo': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
