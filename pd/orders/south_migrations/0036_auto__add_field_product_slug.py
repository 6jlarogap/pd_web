...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('orders_product', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(max_length=255, unique_with=['name'], null=True, populate_from='name'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.slug'
        db.delete_column('orders_product', 'slug')
    ...
    models = {
        ...
        'orders.product': {
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'max_length': '255', 'unique_with': "['name']", 'null': 'True', 'populate_from': "'name'"})
        },
