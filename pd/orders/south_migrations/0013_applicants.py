...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.person'
        db.delete_column('orders_order', 'person_id')

        # Deleting field 'Order.org'
        db.delete_column('orders_order', 'org_id')

        # Adding field 'Order.applicant'
        db.add_column('orders_order', 'applicant',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.AlivePerson'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.applicant_organization'
        db.add_column('orders_order', 'applicant_organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='org_orders', null=True, to=orm['users.Org']),
                      keep_default=False)

        # Adding field 'Order.agent_director'
        db.add_column('orders_order', 'agent_director',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Order.agent'
        db.add_column('orders_order', 'agent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Profile'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)

        # Adding field 'Order.dover'
        db.add_column('orders_order', 'dover',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Dover'], null=True, on_delete=models.PROTECT, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Order.person'
        db.add_column('orders_order', 'person',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.AlivePerson'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.org'
        db.add_column('orders_order', 'org',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='org_orders', null=True, to=orm['users.Org'], blank=True),
                      keep_default=False)

        # Deleting field 'Order.applicant'
        db.delete_column('orders_order', 'applicant_id')

        # Deleting field 'Order.applicant_organization'
        db.delete_column('orders_order', 'applicant_organization_id')

        # Deleting field 'Order.agent_director'
        db.delete_column('orders_order', 'agent_director')

        # Deleting field 'Order.agent'
        db.delete_column('orders_order', 'agent_id')

        # Deleting field 'Order.dover'
        db.delete_column('orders_order', 'dover_id')
