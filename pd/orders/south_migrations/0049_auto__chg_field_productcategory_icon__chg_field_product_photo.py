...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductCategory.icon'
        db.alter_column('orders_productcategory', 'icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Product.photo'
        db.alter_column('orders_product', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'ProductCategory.icon'
        db.alter_column('orders_productcategory', 'icon', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Product.photo'
        db.alter_column('orders_product', 'photo', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
