...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('orders_catafalquedata', 'start', 'start_time')
        db.rename_column('orders_catafalquedata', 'duration', 'duration_time')


    def backwards(self, orm):
        db.rename_column('orders_catafalquedata', 'start_time', 'start')
        db.rename_column('orders_catafalquedata', 'duration_time', 'duration')
