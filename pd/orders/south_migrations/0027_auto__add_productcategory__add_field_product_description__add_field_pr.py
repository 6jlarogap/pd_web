...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('orders_product', 'currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['billing.Currency']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('orders_product', 'currency_id')
