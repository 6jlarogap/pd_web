...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.price_wholesale'
        db.add_column('orders_product', 'price_wholesale',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=20, decimal_places=2),
                      keep_default=False)

        # Adding field 'Product.is_public_catalog'
        db.add_column('orders_product', 'is_public_catalog',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.price_wholesale'
        db.delete_column('orders_product', 'price_wholesale')

        # Deleting field 'Product.is_public_catalog'
        db.delete_column('orders_product', 'is_public_catalog')
