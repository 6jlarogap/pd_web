...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.dt'
        db.add_column('orders_order', 'dt',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 9, 17, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.dt'
        db.delete_column('orders_order', 'dt')
