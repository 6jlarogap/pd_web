...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('orders', ['Route'])

        # Adding unique constraint on 'Route', fields ['order', 'index']
        db.create_unique('orders_route', ['order_id', 'index'])


    def backwards(self, orm):
        # Removing unique constraint on 'Route', fields ['order', 'index']
        db.delete_unique('orders_route', ['order_id', 'index'])

        # Deleting model 'Route'
        db.delete_table('orders_route')
