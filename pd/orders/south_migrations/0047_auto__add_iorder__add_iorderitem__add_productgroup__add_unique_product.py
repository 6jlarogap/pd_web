...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('orders_iorder', (
            ...
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='iorder_customers', to=orm['users.Org'])),
        ...
        db.create_table('orders_productgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('loru', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Org'])),
            ('productcategory', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.ProductCategory'], on_delete=models.PROTECT)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('icon', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('orders', ['ProductGroup'])

        # Adding unique constraint on 'ProductGroup', fields ['loru', 'productcategory', 'name']
        db.create_unique('orders_productgroup', ['loru_id', 'productcategory_id', 'name'])

        # Adding field 'Product.productgroup'
        db.add_column('orders_product', 'productgroup',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.ProductGroup'], null=True, on_delete=models.PROTECT),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'ProductGroup', fields ['loru', 'productcategory', 'name']
        db.delete_unique('orders_productgroup', ['loru_id', 'productcategory_id', 'name'])
        ...
        db.delete_table('orders_productgroup')

        # Deleting field 'Product.productgroup'
        db.delete_column('orders_product', 'productgroup_id')
