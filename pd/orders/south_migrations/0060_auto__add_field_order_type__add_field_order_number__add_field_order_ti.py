...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('orders_order', 'type',
                      self.gf('django.db.models.fields.CharField')(default='burial', max_length=255),
                      keep_default=False)

        # Adding field 'Order.number'
        db.add_column('orders_order', 'number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Order.title'
        db.add_column('orders_order', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Order.phones'
        db.add_column('orders_order', 'phones',
        ...
        db.add_column('orders_orderitem', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'OrderItem.measure'
        db.add_column('orders_orderitem', 'measure',
                      self.gf('django.db.models.fields.CharField')(default=u'\u0448\u0442', max_length=255),
                      keep_default=False)

        # Adding field 'OrderItem.description'
        db.add_column('orders_orderitem', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'OrderItem.productcategory'
        db.add_column('orders_orderitem', 'productcategory',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['orders.ProductCategory'], on_delete=models.PROTECT),
                      keep_default=False)

        # Adding field 'OrderItem.productcategory_name'
        db.add_column('orders_orderitem', 'productcategory_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'OrderItem.productgroup'
        db.add_column('orders_orderitem', 'productgroup',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.ProductGroup'], null=True, on_delete=models.PROTECT),
                      keep_default=False)

        # Adding field 'OrderItem.productgroup_name'
        db.add_column('orders_orderitem', 'productgroup_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'OrderItem.productgroup_description'
        db.add_column('orders_orderitem', 'productgroup_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'OrderItem.comment'
        db.add_column('orders_orderitem', 'comment',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'OrderItem.is_wholesale_with_vat'
        db.add_column('orders_orderitem', 'is_wholesale_with_vat',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('orders_order', 'number')

        # Deleting field 'Order.title'
        db.delete_column('orders_order', 'title')

        # Deleting field 'Order.phones'
        db.delete_column('orders_order', 'phones')

        # Deleting field 'Order.address'
        db.delete_column('orders_order', 'address_id')

        # Deleting field 'OrderItem.name'
        db.delete_column('orders_orderitem', 'name')

        # Deleting field 'OrderItem.measure'
        db.delete_column('orders_orderitem', 'measure')

        # Deleting field 'OrderItem.description'
        db.delete_column('orders_orderitem', 'description')

        # Deleting field 'OrderItem.productcategory'
        db.delete_column('orders_orderitem', 'productcategory_id')

        # Deleting field 'OrderItem.productcategory_name'
        db.delete_column('orders_orderitem', 'productcategory_name')

        # Deleting field 'OrderItem.productgroup'
        db.delete_column('orders_orderitem', 'productgroup_id')

        # Deleting field 'OrderItem.productgroup_name'
        db.delete_column('orders_orderitem', 'productgroup_name')

        # Deleting field 'OrderItem.productgroup_description'
        db.delete_column('orders_orderitem', 'productgroup_description')

        # Deleting field 'OrderItem.comment'
        db.delete_column('orders_orderitem', 'comment')

        # Deleting field 'OrderItem.is_wholesale_with_vat'
        db.delete_column('orders_orderitem', 'is_wholesale_with_vat')
    ...
    models = {
        ...
        'orders.order': {
            ...
            'customplace': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['persons.CustomPlace']", 'null': 'True'}),
            'dover': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.Dover']", 'null': 'True', 'on_delete': 'models.PROTECT', 'blank': 'True'}),
