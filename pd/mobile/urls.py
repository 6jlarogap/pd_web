...
urlpatterns = [
    ...
    re_path(r'^api/mobile/cemetery/(?P<pk>[0-9]+)/photo/?$', views.cemetery_photo),
    re_path(r'^api/mobile/cemetery/(?P<pk>[0-9]+)/schema/?$', views.cemetery_schema),

    re_path(r'^mobile/area/$', views.area_list),
    re_path(r'^mobile/place/$', views.place_list),
    re_path(r'^api/mobile/place/(?P<place_id>[0-9]+)/?$', views.api_mobile_place),
    re_path(r'^api/mobile/area/(?P<area_id>[0-9]+)/places/?$', views.api_mobile_area_places),
