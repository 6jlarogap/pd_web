...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeathCertificate.type'
        db.add_column('persons_deathcertificate', 'type',
                      self.gf('django.db.models.fields.CharField')(default='zags', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeathCertificate.type'
        db.delete_column('persons_deathcertificate', 'type')
