...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomPerson.person'
        db.add_column('persons_customperson', 'person',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['persons.BasePerson'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomPerson.person'
        db.delete_column('persons_customperson', 'person_id')
