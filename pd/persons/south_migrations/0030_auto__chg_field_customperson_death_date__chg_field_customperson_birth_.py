...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CustomPerson.death_date'
        db.alter_column('persons_customperson', 'death_date', self.gf('pd.models.UnclearDateModelField')(null=True))

        # Changing field 'CustomPerson.birth_date'
        db.alter_column('persons_customperson', 'birth_date', self.gf('pd.models.UnclearDateModelField')(null=True))

        # Changing field 'DeadPerson.death_date'
        db.alter_column('persons_deadperson', 'death_date', self.gf('pd.models.UnclearDateModelField')(null=True))

        # Changing field 'BasePerson.birth_date'
        db.alter_column('persons_baseperson', 'birth_date', self.gf('pd.models.UnclearDateModelField')(null=True))

    def backwards(self, orm):

        # Changing field 'CustomPerson.death_date'
        db.alter_column('persons_customperson', 'death_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'CustomPerson.birth_date'
        db.alter_column('persons_customperson', 'birth_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'DeadPerson.death_date'
        db.alter_column('persons_deadperson', 'death_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'BasePerson.birth_date'
        db.alter_column('persons_baseperson', 'birth_date', self.gf('django.db.models.fields.DateField')(null=True))
