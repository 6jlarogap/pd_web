...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomPerson.photo'
        db.add_column('persons_customperson', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CustomPerson.original_filename'
        db.add_column('persons_customperson', 'original_filename',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomPerson.photo'
        db.delete_column('persons_customperson', 'photo')

        # Deleting field 'CustomPerson.original_filename'
        db.delete_column('persons_customperson', 'original_filename')
