...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomPlace.title_photo'
        db.add_column('persons_customplace', 'title_photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomPlace.title_photo'
        db.delete_column('persons_customplace', 'title_photo')
