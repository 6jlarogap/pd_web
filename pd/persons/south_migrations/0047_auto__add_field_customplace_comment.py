...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomPlace.comment'
        db.add_column('persons_customplace', 'comment',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomPlace.comment'
        db.delete_column('persons_customplace', 'comment')
