...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AlivePerson'
        db.create_table('persons_aliveperson', (
        ...
        db.send_create_signal('persons', ['AlivePerson'])
        ...
        db.create_table('persons_deadperson', (
            ('baseperson_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['persons.BasePerson'], unique=True, primary_key=True)),
            ('death_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal('persons', ['DeadPerson'])

        # Adding model 'DeathCertificate'
        db.create_table('persons_deathcertificate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('person', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['persons.DeadPerson'], unique=True)),
        ...
        db.create_table('persons_personid', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('person', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['persons.BasePerson'], unique=True)),
        ...
        db.create_table('persons_baseperson', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('persons', ['BasePerson'])


    def backwards(self, orm):
        # Deleting model 'AlivePerson'
        db.delete_table('persons_aliveperson')

        # Deleting model 'DocumentSource'
        db.delete_table('persons_documentsource')

        # Deleting model 'DeadPerson'
        db.delete_table('persons_deadperson')
        ...
        db.delete_table('persons_baseperson')
