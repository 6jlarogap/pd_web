...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CustomPerson'
        db.create_table('persons_customperson', (
            ...
            (u'birth_date_no_month', self.gf('django.db.models.fields.BooleanField')(default=False)),
            (u'birth_date_no_day', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('birth_date', self.gf('pd.models.UnclearDateModelField')(null=True, blank=True)),
            ...
            ('is_dead', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('customplace', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.CustomPlace'], null=True, blank=True)),
        ))
        db.send_create_signal('persons', ['CustomPerson'])

        # Adding model 'CustomPlace'
        db.create_table('persons_customplace', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dt_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('dt_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ...
        db.send_create_signal('persons', ['CustomPlace'])


    def backwards(self, orm):
        # Deleting model 'CustomPerson'
        db.delete_table('persons_customperson')

        # Deleting model 'CustomPlace'
        db.delete_table('persons_customplace')
