...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MemoryGalleryPermission'
        db.create_table('persons_memorygallerypermission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('memorygallery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.MemoryGallery'])),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True)),
            ('login_phone', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=0)),
        ))
        db.send_create_signal('persons', ['MemoryGalleryPermission'])

        # Adding field 'MemoryGallery.permission'
        db.add_column('persons_memorygallery', 'permission',
                      self.gf('django.db.models.fields.CharField')(default='private', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'MemoryGalleryPermission'
        db.delete_table('persons_memorygallerypermission')

        # Deleting field 'MemoryGallery.permission'
        db.delete_column('persons_memorygallery', 'permission')
