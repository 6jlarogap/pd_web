...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlivePerson.is_inbook'
        db.add_column('persons_aliveperson', 'is_inbook',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlivePerson.is_inbook'
        db.delete_column('persons_aliveperson', 'is_inbook')
