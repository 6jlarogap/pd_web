...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('persons_deathcertificate', 'zags_id')


    def backwards(self, orm):
        # Adding field 'DeathCertificate.zags'
        db.add_column('persons_deathcertificate', 'zags',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.ZAGS'], null=True),
                      keep_default=False)
