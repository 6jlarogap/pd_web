...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeathCertificateScan'
        db.create_table('persons_deathcertificatescan', (
            ...
            ('deathcertificate', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['persons.DeathCertificate'], unique=True)),
        ))
        db.send_create_signal('persons', ['DeathCertificateScan'])


    def backwards(self, orm):
        # Deleting model 'DeathCertificateScan'
        db.delete_table('persons_deathcertificatescan')
