...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlivePerson.login_phone'
        db.add_column('persons_aliveperson', 'login_phone',
                      self.gf('django.db.models.fields.DecimalField')(db_index=True, null=True, max_digits=15, decimal_places=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlivePerson.login_phone'
        db.delete_column('persons_aliveperson', 'login_phone')
