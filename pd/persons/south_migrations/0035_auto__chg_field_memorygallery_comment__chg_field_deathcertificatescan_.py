...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MemoryGallery.comment'
        db.alter_column('persons_memorygallery', 'comment', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'DeathCertificateScan.comment'
        db.alter_column('persons_deathcertificatescan', 'comment', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'MemoryGallery.comment'
        db.alter_column('persons_memorygallery', 'comment', self.gf('django.db.models.fields.CharField')(max_length=96))

        # Changing field 'DeathCertificateScan.comment'
        db.alter_column('persons_deathcertificatescan', 'comment', self.gf('django.db.models.fields.CharField')(max_length=96))
