...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CustomPersonPermission'
        db.create_table('persons_custompersonpermission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('customperson', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.CustomPerson'])),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True)),
            ('login_phone', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=0)),
        ))
        db.send_create_signal('persons', ['CustomPersonPermission'])

        # Adding field 'CustomPerson.permission'
        db.add_column('persons_customperson', 'permission',
                      self.gf('django.db.models.fields.CharField')(default='private', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CustomPersonPermission'
        db.delete_table('persons_custompersonpermission')

        # Deleting field 'CustomPerson.permission'
        db.delete_column('persons_customperson', 'permission')
