...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'IDDocumentType', fields ['name']
        db.create_index('persons_iddocumenttype', ['name'])


    def backwards(self, orm):
        # Removing index on 'IDDocumentType', fields ['name']
        db.delete_index('persons_iddocumenttype', ['name'])
