...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomPlace.place'
        db.add_column('persons_customplace', 'place',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['burials.Place'], null=True),
                      keep_default=False)

        # Adding unique constraint on 'CustomPlace', fields ['place', 'user']
        db.create_unique('persons_customplace', ['place_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CustomPlace', fields ['place', 'user']
        db.delete_unique('persons_customplace', ['place_id', 'user_id'])

        # Deleting field 'CustomPlace.place'
        db.delete_column('persons_customplace', 'place_id')
