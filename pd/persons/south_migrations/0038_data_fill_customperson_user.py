...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Заполнить CustomPerson.user из CustomPlace.user
        #
        print "*** Filling CustomPerson.user with CustomPlace.user"

        CustomPlace = orm['persons.CustomPlace']
        CustomPerson = orm['persons.CustomPerson']
        for customplace in CustomPlace.objects.all():
            CustomPerson.objects.filter(customplace=customplace).update(user=customplace.user)
