...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeathCertificate.creator'
        db.add_column('persons_deathcertificate', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='persons_deathcertificate_creator_related', null=True, on_delete=models.PROTECT, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'DeathCertificate.modifier'
        db.add_column('persons_deathcertificate', 'modifier',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='persons_deathcertificate_modifier_related', null=True, on_delete=models.PROTECT, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'DeathCertificate.dt_created'
        db.add_column('persons_deathcertificate', 'dt_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 4, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'DeathCertificate.dt_modified'
        db.add_column('persons_deathcertificate', 'dt_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 9, 4, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeathCertificate.creator'
        db.delete_column('persons_deathcertificate', 'creator_id')

        # Deleting field 'DeathCertificate.modifier'
        db.delete_column('persons_deathcertificate', 'modifier_id')

        # Deleting field 'DeathCertificate.dt_created'
        db.delete_column('persons_deathcertificate', 'dt_created')

        # Deleting field 'DeathCertificate.dt_modified'
        db.delete_column('persons_deathcertificate', 'dt_modified')
    ...
    models = {
        ...
        'persons.deathcertificate': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'persons_deathcertificate_creator_related'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': "orm['auth.User']"}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifier': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'persons_deathcertificate_modifier_related'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': "orm['auth.User']"}),
