...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonID.date_expire'
        db.add_column('persons_personid', 'date_expire',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonID.date_expire'
        db.delete_column('persons_personid', 'date_expire')
