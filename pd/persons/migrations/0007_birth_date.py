...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('persons_deadperson', 'birth_date_no_month',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DeadPerson.birth_date_no_day'
        db.add_column('persons_deadperson', 'birth_date_no_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'BasePerson.birth_date_no_day'
        db.delete_column('persons_baseperson', 'birth_date_no_day')
        ...
        db.delete_column('persons_baseperson', 'birth_date_no_month')
    ...
    def backwards(self, orm):
        ...
        db.delete_column('persons_deadperson', 'birth_date_no_month')

        # Deleting field 'DeadPerson.birth_date_no_day'
        db.delete_column('persons_deadperson', 'birth_date_no_day')

        # Adding field 'BasePerson.birth_date_no_day'
        db.add_column('persons_baseperson', 'birth_date_no_day',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        ...
        db.add_column('persons_baseperson', 'birth_date_no_month',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        'persons.deathcertificate': {
            ...
            'zags': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.Org']", 'null': 'True'})
        },
