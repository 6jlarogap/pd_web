...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BasePerson.address'
        db.alter_column('persons_baseperson', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.Location'], null=True, on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'BasePerson.address'
        db.alter_column('persons_baseperson', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.Location'], null=True))
