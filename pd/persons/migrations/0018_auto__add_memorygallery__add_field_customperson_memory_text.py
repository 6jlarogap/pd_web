...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MemoryGallery'
        db.create_table('persons_memorygallery', (
            ...
            (u'event_date_no_month', self.gf('django.db.models.fields.BooleanField')(default=False)),
            (u'event_date_no_day', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('event_date', self.gf('pd.models.UnclearDateModelField')(null=True)),
        ))
        db.send_create_signal('persons', ['MemoryGallery'])

        # Adding field 'CustomPerson.memory_text'
        db.add_column('persons_customperson', 'memory_text',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'MemoryGallery'
        db.delete_table('persons_memorygallery')

        # Deleting field 'CustomPerson.memory_text'
        db.delete_column('persons_customperson', 'memory_text')
    ...
    models = {
        ...
        'users.org': {
            ...
            'fax': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20'}),
