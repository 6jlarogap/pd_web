...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomPerson.token'
        db.add_column('persons_customperson', 'token',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)

        # Adding field 'CustomPerson.thank_site'
        db.add_column('persons_customperson', 'thank_site',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomPerson.token'
        db.delete_column('persons_customperson', 'token')

        # Deleting field 'CustomPerson.thank_site'
        db.delete_column('persons_customperson', 'thank_site')
