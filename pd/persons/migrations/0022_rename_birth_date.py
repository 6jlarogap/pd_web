...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ## Deleting field 'BasePerson.birth_date_temp'
        #db.delete_column('persons_baseperson', 'birth_date_temp')

        ## Deleting field 'BasePerson.birth_date_temp_no_month'
        #db.delete_column('persons_baseperson', u'birth_date_temp_no_month')

        ## Deleting field 'BasePerson.birth_date_temp_no_day'
        #db.delete_column('persons_baseperson', u'birth_date_temp_no_day')

        ## Adding field 'BasePerson.birth_date_no_month'
        #db.add_column('persons_baseperson', u'birth_date_no_month',
                      #self.gf('django.db.models.fields.BooleanField')(default=False),
                      #keep_default=False)

        ## Adding field 'BasePerson.birth_date_no_day'
        #db.add_column('persons_baseperson', u'birth_date_no_day',
                      #self.gf('django.db.models.fields.BooleanField')(default=False),
                      #keep_default=False)

        ## Adding field 'BasePerson.birth_date'
        #db.add_column('persons_baseperson', 'birth_date',
                      #self.gf('pd.models.UnclearDateModelField')(null=True, blank=True),
                      #keep_default=False)

        db.rename_column('persons_baseperson', 'birth_date_temp', 'birth_date')
        db.rename_column('persons_baseperson', 'birth_date_temp_no_month', 'birth_date_no_month')
        db.rename_column('persons_baseperson', 'birth_date_temp_no_day', 'birth_date_no_day')

    def backwards(self, orm):
        ## Adding field 'BasePerson.birth_date_temp'
        #db.add_column('persons_baseperson', 'birth_date_temp',
                      #self.gf('pd.models.UnclearDateModelField')(null=True, blank=True),
                      #keep_default=False)

        ## Adding field 'BasePerson.birth_date_temp_no_month'
        #db.add_column('persons_baseperson', u'birth_date_temp_no_month',
                      #self.gf('django.db.models.fields.BooleanField')(default=False),
                      #keep_default=False)

        ## Adding field 'BasePerson.birth_date_temp_no_day'
        #db.add_column('persons_baseperson', u'birth_date_temp_no_day',
                      #self.gf('django.db.models.fields.BooleanField')(default=False),
                      #keep_default=False)

        ## Deleting field 'BasePerson.birth_date_no_month'
        #db.delete_column('persons_baseperson', u'birth_date_no_month')

        ## Deleting field 'BasePerson.birth_date_no_day'
        #db.delete_column('persons_baseperson', u'birth_date_no_day')

        ## Deleting field 'BasePerson.birth_date'
        #db.delete_column('persons_baseperson', 'birth_date')

        db.rename_column('persons_baseperson', 'birth_date', 'birth_date_temp')
        db.rename_column('persons_baseperson', 'birth_date_no_month', 'birth_date_temp_no_month')
        db.rename_column('persons_baseperson', 'birth_date_no_day', 'birth_date_temp_no_day')
