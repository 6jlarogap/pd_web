...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('persons_person', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='created_persons', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Person.date_of_creation'
        db.add_column('persons_person', 'date_of_creation',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('persons_person', 'creator_id')

        # Deleting field 'Person.date_of_creation'
        db.delete_column('persons_person', 'date_of_creation')
