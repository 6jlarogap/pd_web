...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrderDeadPerson'
        db.create_table('persons_orderdeadperson', (
            ('baseperson_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['persons.BasePerson'], unique=True, primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['orders.Order'], unique=True)),
            (u'death_date_no_month', self.gf('django.db.models.fields.BooleanField')(default=False)),
            (u'death_date_no_day', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('death_date', self.gf('pd.models.UnclearDateModelField')(null=True, blank=True)),
        ))
        db.send_create_signal('persons', ['OrderDeadPerson'])


    def backwards(self, orm):
        # Deleting model 'OrderDeadPerson'
        db.delete_table('persons_orderdeadperson')
    ...
    models = {
        ...
        'persons.custompersonpermission': {
            'Meta': {'object_name': 'CustomPersonPermission'},
            'customperson': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['persons.CustomPerson']"}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login_phone': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '0'})
        },
        'persons.customplace': {
        ...
        'persons.deathcertificate': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "'zags'", 'max_length': '255'}),
        ...
        'persons.memorygallerypermission': {
            'Meta': {'object_name': 'MemoryGalleryPermission'},
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login_phone': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '0'}),
            'memorygallery': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['persons.MemoryGallery']"})
        },
        'persons.orderdeadperson': {
            'Meta': {'ordering': "['last_name', 'first_name', 'middle_name']", 'object_name': 'OrderDeadPerson', '_ormbases': ['persons.BasePerson']},
            'baseperson_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['persons.BasePerson']", 'unique': 'True', 'primary_key': 'True'}),
            'death_date': ('pd.models.UnclearDateModelField', [], {'null': 'True', 'blank': 'True'}),
            u'death_date_no_day': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'death_date_no_month': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
