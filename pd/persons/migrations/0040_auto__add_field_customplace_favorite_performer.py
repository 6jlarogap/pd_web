...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomPlace.favorite_performer'
        db.add_column('persons_customplace', 'favorite_performer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Org'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomPlace.favorite_performer'
        db.delete_column('persons_customplace', 'favorite_performer_id')
