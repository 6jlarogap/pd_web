...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='AlivePerson',
            fields=[
                ('baseperson_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='persons.BasePerson')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permission', models.CharField(default=b'private', max_length=255, verbose_name='\u0420\u0430\u0437\u0440\u0435\u0448\u0435\u043d\u0438\u0435', choices=[(b'private', '\u041b\u0438\u0447\u043d\u043e\u0435'), (b'public', '\u0412 \u043f\u0443\u0431\u043b\u0438\u0447\u043d\u043e\u043c \u0434\u043e\u0441\u0442\u0443\u043f\u0435'), (b'selected', '\u0412\u044b\u0431\u043e\u0440\u043e\u0447\u043d\u043e')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_photo', models.ImageField(upload_to=b'.', null=True, verbose_name='\u041e\u0441\u043d\u043e\u0432\u043d\u043e\u0435 \u0424\u043e\u0442\u043e')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dt_created', models.DateTimeField(auto_now_add=True, verbose_name='\u0414\u0430\u0442\u0430/\u0432\u0440\u0435\u043c\u044f \u0441\u043e\u0437\u0434\u0430\u043d\u0438\u044f')),
                ('dt_modified', models.DateTimeField(auto_now=True, verbose_name='\u0414\u0430\u0442\u0430/\u0432\u0440\u0435\u043c\u044f \u043c\u043e\u0434\u0438\u0444\u0438\u043a\u0430\u0446\u0438\u0438')),
                ('type', models.CharField(default=b'zags', max_length=255, verbose_name='\u0422\u0438\u043f', choices=[(b'zags', '\u0421\u0432\u0438\u0434\u0435\u0442\u0435\u043b\u044c\u0441\u0442\u0432\u043e \u043e \u0441\u043c\u0435\u0440\u0442\u0438'), (b'medic', '\u041c\u0435\u0434\u0438\u0446\u0438\u043d\u0441\u043a\u0430\u044f \u0441\u043f\u0440\u0430\u0432\u043a\u0430')])),
                ...
                ('person', models.OneToOneField(to='persons.DeadPerson')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deathcertificate', models.OneToOneField(to='persons.DeathCertificate')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original_name', models.CharField(max_length=255, editable=False)),
                ('date_of_creation', models.DateTimeField(auto_now_add=True)),
                ('type', models.CharField(max_length=255, verbose_name='\u0422\u0438\u043f', choices=[(b'image', '\u0424\u043e\u0442\u043e'), (b'video', '\u0412\u0438\u0434\u0435\u043e'), (b'text', '\u0422\u0435\u043a\u0441\u0442'), (b'link', '\u0421\u0441\u044b\u043b\u043a\u0430')])),
                ...
                ('permission', models.CharField(default=b'private', max_length=255, verbose_name='\u0420\u0430\u0437\u0440\u0435\u0448\u0435\u043d\u0438\u0435', choices=[(b'private', '\u041b\u0438\u0447\u043d\u043e\u0435'), (b'public', '\u0412 \u043f\u0443\u0431\u043b\u0438\u0447\u043d\u043e\u043c \u0434\u043e\u0441\u0442\u0443\u043f\u0435'), (b'selected', '\u0412\u044b\u0431\u043e\u0440\u043e\u0447\u043d\u043e')])),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, editable=False, to=settings.AUTH_USER_MODEL, null=True, verbose_name='\u0421\u043e\u0437\u0434\u0430\u0442\u0435\u043b\u044c')),
                ('customperson', models.ForeignKey(to='persons.CustomPerson')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('death_date_no_day', models.BooleanField(default=False, editable=False)),
                ('death_date', pd.models.UnclearDateModelField(serialize=False, null=True, verbose_name='\u0414\u0430\u0442\u0430 \u0441\u043c\u0435\u0440\u0442\u0438', blank=True)),
                ('order', models.OneToOneField(verbose_name='\u0417\u0430\u043a\u0430\u0437', to='orders.Order')),
            ],
            options={
            },
            bases=(persons.models.DeadPersonMixin, 'persons.baseperson'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_type', models.ForeignKey(verbose_name='\u0422\u0438\u043f \u0434\u043e\u043a\u0443\u043c\u0435\u043d\u0442\u0430', blank=True, to='persons.IDDocumentType', null=True)),
                ('person', models.OneToOneField(to='persons.BasePerson')),
                ('source', models.ForeignKey(verbose_name='\u041a\u0435\u043c \u0432\u044b\u0434\u0430\u043d', blank=True, to='persons.DocumentSource', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ct', models.ForeignKey(blank=True, editable=False, to='contenttypes.ContentType', null=True, verbose_name='\u0422\u0438\u043f')),
            ],
            options={
