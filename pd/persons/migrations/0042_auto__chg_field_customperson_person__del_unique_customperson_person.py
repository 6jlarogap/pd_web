...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CustomPerson', fields ['person']
        db.delete_unique('persons_customperson', ['person_id'])


        # Changing field 'CustomPerson.person'
        db.alter_column('persons_customperson', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.BasePerson'], null=True))

    def backwards(self, orm):

        # Changing field 'CustomPerson.person'
        db.alter_column('persons_customperson', 'person_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['persons.BasePerson'], unique=True, null=True))
        # Adding unique constraint on 'CustomPerson', fields ['person']
        db.create_unique('persons_customperson', ['person_id'])
