...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BasePerson.ident_number'
        db.add_column('persons_baseperson', 'ident_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BasePerson.ident_number'
        db.delete_column('persons_baseperson', 'ident_number')
