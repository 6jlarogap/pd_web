...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MemoryGallery.bfile'
        db.alter_column('persons_memorygallery', 'bfile', self.gf('django.db.models.fields.files.FileField')(max_length=255))

        # Changing field 'DeathCertificateScan.bfile'
        db.alter_column('persons_deathcertificatescan', 'bfile', self.gf('django.db.models.fields.files.FileField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'MemoryGallery.bfile'
        db.alter_column('persons_memorygallery', 'bfile', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'DeathCertificateScan.bfile'
        db.alter_column('persons_deathcertificatescan', 'bfile', self.gf('django.db.models.fields.files.FileField')(max_length=100))
